...
class EvaluationScenarioCreate(UniversalBaseModel):
...
update_forward_refs(EvaluationScenarioCreate, FullJsonInput=FullJsonInput, LabelJsonInput=LabelJsonInput)
