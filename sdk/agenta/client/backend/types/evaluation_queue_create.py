...
class EvaluationQueueCreate(UniversalBaseModel):
    flags: typing.Optional[EvaluationQueueFlags] = None
...
update_forward_refs(EvaluationQueueCreate, FullJsonInput=FullJsonInput, LabelJsonInput=LabelJsonInput)
