...
class EvaluationMetricsQuery(UniversalBaseModel):
    ...
    timestamps: typing.Optional[EvaluationMetricsQueryTimestamps] = None
    scenario_id: typing.Optional[str] = None
    scenario_ids: typing.Optional[EvaluationMetricsQueryScenarioIds] = None
