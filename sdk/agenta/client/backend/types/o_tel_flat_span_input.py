...
class OTelFlatSpanInput(UniversalBaseModel):
    ...
    start_time: typing.Optional[OTelFlatSpanInputStartTime] = None
    end_time: typing.Optional[OTelFlatSpanInputEndTime] = None
...
update_forward_refs(OTelFlatSpanInput, FullJsonInput=FullJsonInput)
