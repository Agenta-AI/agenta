...
class LegacyApplication(UniversalBaseModel):
    ...
    data: typing.Optional[LegacyApplicationDataOutput] = None
...
update_forward_refs(LegacyApplication, FullJsonOutput=FullJsonOutput, LabelJsonOutput=LabelJsonOutput)
