...
class InvocationQuery(UniversalBaseModel):
    ...
    links: typing.Optional[InvocationQueryLinks] = None
...
update_forward_refs(InvocationQuery, FullJsonInput=FullJsonInput, LabelJsonInput=LabelJsonInput)
