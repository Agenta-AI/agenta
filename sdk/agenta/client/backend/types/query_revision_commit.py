...
class QueryRevisionCommit(UniversalBaseModel):
    ...
    data: typing.Optional[QueryRevisionDataInput] = None
...
update_forward_refs(QueryRevisionCommit, FullJsonInput=FullJsonInput, LabelJsonInput=LabelJsonInput)
