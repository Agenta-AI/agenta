...
class EvaluationRun(UniversalBaseModel):
    ...
    data: typing.Optional[EvaluationRunDataOutput] = None
...
update_forward_refs(EvaluationRun, FullJsonOutput=FullJsonOutput, LabelJsonOutput=LabelJsonOutput)
