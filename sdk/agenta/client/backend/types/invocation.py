...
class Invocation(UniversalBaseModel):
    ...
    links: typing.Optional[InvocationLinks] = None
...
update_forward_refs(Invocation, FullJsonOutput=FullJsonOutput, LabelJsonOutput=LabelJsonOutput)
