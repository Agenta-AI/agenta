...
class EvaluationResultCreate(UniversalBaseModel):
    ...
    error: typing.Optional[typing.Dict[str, typing.Optional["FullJsonInput"]]] = None
...
update_forward_refs(EvaluationResultCreate, FullJsonInput=FullJsonInput, LabelJsonInput=LabelJsonInput)
