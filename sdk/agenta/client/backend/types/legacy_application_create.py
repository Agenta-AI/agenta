...
class LegacyApplicationCreate(UniversalBaseModel):
    flags: typing.Optional[LegacyApplicationFlags] = None
    ...
    data: typing.Optional[LegacyApplicationDataInput] = None
...
update_forward_refs(LegacyApplicationCreate, FullJsonInput=FullJsonInput, LabelJsonInput=LabelJsonInput)
