...
class TestcaseOutput(UniversalBaseModel):
    ...
    data: typing.Optional[typing.Dict[str, typing.Optional["FullJsonOutput"]]] = None
...
update_forward_refs(TestcaseOutput, FullJsonOutput=FullJsonOutput, LabelJsonOutput=LabelJsonOutput)
