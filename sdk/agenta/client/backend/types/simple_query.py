...
class SimpleQuery(UniversalBaseModel):
    ...
    data: typing.Optional[QueryRevisionDataOutput] = None
...
update_forward_refs(SimpleQuery, FullJsonOutput=FullJsonOutput, LabelJsonOutput=LabelJsonOutput)
