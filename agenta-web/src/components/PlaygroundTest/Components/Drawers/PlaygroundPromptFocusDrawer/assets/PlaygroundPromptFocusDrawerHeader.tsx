...
import {PlaygroundPromptFocusDrawerHeaderProps} from "./types"
import React from "react"

const PlaygroundPromptFocusDrawerHeader: React.FC<PlaygroundPromptFocusDrawerHeaderProps> = ({
    variantName,
    revision,
}) => {
    return (
...
export default PlaygroundPromptFocusDrawerHeader
