...
import {PlaygroundGenerationOutputUtilsProps} from "./types"
import clsx from "clsx"

const PlaygroundGenerationOutputUtils: React.FC<PlaygroundGenerationOutputUtilsProps> = ({
    className,
}) => {
...
export default PlaygroundGenerationOutputUtils
