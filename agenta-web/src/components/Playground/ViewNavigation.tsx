          ...
          <div>
            ...
            <ul>
              ...
              <li>
                ...
                {variantDesignator} is running. The image should be called{" "}
                {imageName}.
              </li>
            </ul>
            <p>
              {" "}
              In case the docker container is not running. Please simply start
              it (using cli or docker desktop)
            </p>
            <p>
              {" "}
              If the issue persists please file an issue in github or directly
              contact us under team@agenta.ai
            </p>
