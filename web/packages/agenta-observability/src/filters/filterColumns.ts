/**
 * The observability filter field table.
 *
 * Pure metadata — icons are a host concern and get overlaid by
 * `getFilterColumns`, so this table is shareable across surfaces with
 * different icon sets.
 */
import {
...
import type {FilterMenuNode} from "./types"
