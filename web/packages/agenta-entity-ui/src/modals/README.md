    ...
    return (
        <div>
            ...
            <Button
                danger
                onClick={() =>
                    dispatch(deleteAction([{type: "testset", id: entity.id, name: entity.name}]))
                }
            >
                Delete
            </Button>
...
function EntityActions({entity}: {entity: Entity}) {
    ...
    return (
        <div>
            <Button onClick={() => commitEntity("testset", entity.id, entity.name)}>Commit</Button>
            <Button onClick={() => saveEntity("testset", entity.id, entity.name)}>Save</Button>
            <Button onClick={() => createEntity("testset")}>Create New</Button>
