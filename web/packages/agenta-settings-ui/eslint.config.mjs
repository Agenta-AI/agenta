/**
 * @agenta/settings-ui is antd-FREE by contract — mobile consumes these components without
 * pulling antd. Anything not yet portable (an app-only flow) is a slot the app injects.
                    ...
                    patterns: [
                        {
                            ...
                            message:
                                "@agenta/settings-ui is antd-free. Use the Radix primitives from '@agenta/ui/ui', or take the element as a slot.",
                        },
                    ],
                },
            ],
