/**
 * @agenta/observability-ui is antd-FREE by contract — mobile consumes these components without
 * pulling antd. Anything not yet portable (the evaluator-reference lookup, the onboarding CTA) is a slot the app injects.
                    ...
                    patterns: [
                        {
                            ...
                            message:
                                "@agenta/observability-ui is antd-free. Use the Radix primitives from '@agenta/ui/ui', or take the element as a slot.",
                        },
                    ],
                },
            ],
