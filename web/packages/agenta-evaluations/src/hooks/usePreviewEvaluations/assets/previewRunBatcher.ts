/* eslint-disable @typescript-eslint/no-explicit-any -- relocated preview-run batcher; caches dynamic backend-shaped run payloads, logic unchanged from OSS origin */
