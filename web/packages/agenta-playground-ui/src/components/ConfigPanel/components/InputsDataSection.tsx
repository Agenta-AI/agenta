...
import {runnableBridge, type RunnableType, type TestsetColumn} from "@agenta/entities/runnable"
import {cn, statusColors, textColors, bgColors, borderColors} from "@agenta/ui/styles"
...
export function InputsDataSection({
    ...
    // Use bridge selector for input ports
    const inputPortsAtom = useMemo(() => runnableBridge.inputPorts(entity.id), [entity.id])
    ...
    // For downstream nodes (when columns prop is empty), derive columns from inputPorts
