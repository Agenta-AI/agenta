/**
 * @agenta/settings is antd-FREE by contract — mobile consumes these components without
                    ...
                    patterns: [
                        {
                            ...
                            message:
                                "@agenta/settings is antd-free. Use the Radix primitives from '@agenta/ui/ui', or take the element as a slot.",
                        },
                    ],
                },
            ],
