 ...
 *
 * Re-exports pure schema utilities from schemaUtils.ts and adds
 * network-dependent fetchServiceSchema.
 */
...
import {buildRevisionSchemaState} from "./schemaUtils"
import type {OpenAPISpec} from "./schemaUtils"
