 ...
 *
 * One request for the whole roster: the project-wide gate poll supplies the ids, which go back to
 ...
 * is a short, stable list, so it stays cheap where the session list (long, polling) would not.
 */
