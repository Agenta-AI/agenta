...
export class KeysClient {
     ...
     */
    public createApiKey(requestOptions?: KeysClient.RequestOptions): core.HttpResponsePromise<string> {
        return core.HttpResponsePromise.fromPromise(this.__createApiKey(requestOptions));
    }

    private async __createApiKey(requestOptions?: KeysClient.RequestOptions): Promise<core.WithRawResponse<string>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
     ...
     *
     * @example
     *     await client.keys.deleteApiKey({
