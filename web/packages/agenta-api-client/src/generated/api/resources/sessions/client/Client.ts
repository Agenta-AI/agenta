...
export class SessionsClient {
    ...
    /** Fetch the durable execution and pending-input snapshot for a session. */
    public fetchSessionSnapshot(
        request: AgentaApi.FetchSessionSnapshotRequest,
        requestOptions?: SessionsClient.RequestOptions,
    ): core.HttpResponsePromise<AgentaApi.SessionSnapshotResponse> {
        return core.HttpResponsePromise.fromPromise(this.__fetchSessionSnapshot(request, requestOptions));
    }

    private async __fetchSessionSnapshot(
        request: AgentaApi.FetchSessionSnapshotRequest,
        requestOptions?: SessionsClient.RequestOptions,
