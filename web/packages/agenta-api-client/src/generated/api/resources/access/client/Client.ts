...
export class AccessClient {
     ...
     *
     * @example
     *     await client.access.fetchAccessPlans()
     */
    public fetchAccessPlans(
        requestOptions?: AccessClient.RequestOptions,
    ): core.HttpResponsePromise<Record<string, Record<string, unknown>>> {
        return core.HttpResponsePromise.fromPromise(this.__fetchAccessPlans(requestOptions));
    }

    private async __fetchAccessPlans(
        requestOptions?: AccessClient.RequestOptions,
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/access/plans");
    }
     ...
     *
     * @example
     *     await client.access.discoverAccess({
     *         email: "email"
     *     })
     */
    public discoverAccess(
        request: AgentaApi.DiscoverRequest,
        requestOptions?: AccessClient.RequestOptions,
    ): core.HttpResponsePromise<AgentaApi.DiscoverResponse> {
        return core.HttpResponsePromise.fromPromise(this.__discoverAccess(request, requestOptions));
    }

    private async __discoverAccess(
        request: AgentaApi.DiscoverRequest,
        requestOptions?: AccessClient.RequestOptions,
     ...
     *
     * @param {AgentaApi.CheckOrganizationAccessRequest} request
     * @param {AccessClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link AgentaApi.UnprocessableEntityError}
     *
     * @example
     *     await client.access.checkOrganizationAccess({
     *         organization_id: "organization_id"
     *     })
     */
    public checkOrganizationAccess(
        request: AgentaApi.CheckOrganizationAccessRequest,
        requestOptions?: AccessClient.RequestOptions,
     ...
     *
     * @example
     *     await client.access.updateSessionIdentities({
     ...
     *
     * @param {AgentaApi.SsoCallbackRedirectRequest} request
     * @param {AccessClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link AgentaApi.UnprocessableEntityError}
     *
     * @example
     *     await client.access.ssoCallbackRedirect({
     *         organization_slug: "organization_slug",
     *         provider_slug: "provider_slug"
     *     })
     */
    public ssoCallbackRedirect(
        request: AgentaApi.SsoCallbackRedirectRequest,
        requestOptions?: AccessClient.RequestOptions,
    ): core.HttpResponsePromise<unknown> {
