                            ...
                            detail: (
                                <>
                                    ...
                                    <ul style={styles.fileList}>
                                        <li>
                                            <code>TokenNode.ts</code> · custom Lexical
                                            node for <code>{"{{...}}"}</code> tokens
                                        </li>
                                        <li>
                                            <code>TokenInputNode.tsx</code> · input mode
                                            (active typing inside the braces)
                                        </li>
                                        <li>
                                            <code>TokenPlugin.tsx</code> (239 LOC) ·
                                            bracket detection + token conversion +
                                            navigation
                                        </li>
                                        <li>
                                            <code>AutoCloseTokenBracesPlugin.tsx</code>{" "}
                                            (200 LOC) · auto-pair{" "}
                                            <code>{"{{"}</code> →{" "}
                                            <code>{"{{}}"}</code>
                                        </li>
                                        <li>
                                            <code>TokenTypeaheadPlugin.tsx</code> (403
                                            LOC) · suggestion dropdown, parses path /
                                            flat mode, drives the dispatcher
                                        </li>
                                        <li>
                                            <code>TokenTooltipPlugin.tsx</code> (120
                                            LOC) · hover tooltip showing resolved
                                            value + validation hint
                                        </li>
                                        <li>
                                            <code>TokenPathSuggestionsContext.tsx</code>{" "}
                                            (89 LOC) · provider/getter contract used
                                            by the typeahead
                                        </li>
                                    </ul>
                                </>
                        ...
                        },
                        {
                            ...
                            detail: (
                                <>
                                    ...
                                    <code>TokenTypeaheadPlugin.tsx:74</code> handles
                                    both syntaxes:
                        ...
                        },
                        {
                            ...
                            detail: (
                                <>
                                    ...
                                    ) builds on this — the symmetric edit-time check
                                    on the prompt surface uses the same parser + path
                                    splitter. The <code>[draft]</code> chip from
                                    gap-09 fires when this typeahead's suggestion set
                                    doesn't include the typed name.
                                </>
                            ),
                        },
                    ]}
                    ...
                    items={[
                        {
                            ...
                            detail: (
                                <>
                                    ...
                                    defines <code>EnvelopeSource</code> with one
                                    method: <code>getSuggestions(afterSlot, query)</code>.
                                    Each source returns the suggestions for a single
                                    envelope slot; the dispatcher picks the source
                                    matching the first path segment.
                                </>
                            ),
                        },
                        {
                            ...
                            detail: (
                                <>
                                    ...
                                    <ul style={styles.fileList}>
                                        <li>
                                            <code>inputs.ts</code> (135 LOC) · port
                                            schemas + observed testcase keys, depth-2
                                            walk
                                        </li>
                                        <li>
                                            <code>outputs.ts</code> (94 LOC) ·
                                            upstream-node output schema, scoped to
                                            the chain context
                                        </li>
                                        <li>
                                            <code>parameters.ts</code> (61 LOC) ·
                                            evaluator parameters slot
                                        </li>
                                        <li>
                                            <code>testcase.ts</code> (43 LOC) · direct
                                            testcase row keys
                                        </li>
                                        <li>
                                            <code>shared.ts</code> (84 LOC) · common
                                            type/schema helpers
                                        </li>
                                    </ul>
                                </>
                        ...
                        },
                        {
                            ...
                            detail: (
                                <>
                                    ...
                                    <ul style={styles.fileList}>
                                        <li>
                                            <code>PlaygroundTokenPathProvider</code> ·
                                            global, offers only <code>$.inputs</code>{" "}
                                            (covers detached editors with no node
                                            context).
                                        </li>
                                        <li>
                                            <code>
                                            ...
                                            · scoped per node, adds <code>$.outputs</code>{" "}
                                            when the node has an upstream connection
                                            in the playground DAG.
                                        </li>
                                    </ul>
                                </>
                            ),
                    ...
                    items={[
                        {
                            ...
                            detail: (
                                <>
                                    ...
                                    · <code>nodeChainContextAtomFamily</code>{" "}
                                    derives <code>{"{allowedSlots, upstreamEntityId}"}</code>{" "}
                                    from <code>playgroundNodesAtom</code> +{" "}
                        ...
                        },
                        {
                            ...
                            detail: (
                                <>
                                    ...
                                    <code>auto_ai_critique_v0</code> receives{" "}
                                    <code>outputs</code>; <code>completion_v0</code>{" "}
                                    and <code>chat_v0</code> don't. The typeahead
                                    matches runtime reality, so suggestions for{" "}
                                    <code>$.outputs.*</code> never appear in a depth-0
                                    editor where they'd be unreplaced tokens at
                                    format time.
                                </>
                            ),
                        },
                        {
                            ...
                            detail: (
                                <>
                                    ...
                                    <code>prompt 1, 3 of 4</code>) reads from this
                                    same chain context. Per-prompt usage scope can
                                    join the suggestion-source map and the editor's
                                    parsed token list to produce the badge for
                                    free. See{" "}
                                    <Link
                    ...
                    items={[
                        {
                            ...
                            detail: (
                                <>
                                    ...
                                    <ul style={styles.fileList}>
                                        <li>
                                            <code>KNOWN_ENVELOPE_SLOTS</code> · the
                                            registry: <code>inputs</code>,{" "}
                                            <code>outputs</code>,{" "}
                                        ...
                                        <li>
                                            <code>validateTemplateVariable(expr)</code>{" "}
                                            · returns{" "}
                                            <code>
                                                {"{valid, reason?, suggestion?}"}
                                            </code>{" "}
                                            for use in the editor's red-bordered
                                            invalid-token tooltip.
                                        </li>
                                        <li>
                                            <code>suggestEnvelopeSlot(typed)</code> ·
                                            "did you mean…?" for near-miss typos
                                            (e.g. <code>input</code> →{" "}
                                            <code>inputs</code>).
                                        </li>
                                    </ul>
                            ...
                            detail: (
                                <>
                                    <ul style={styles.list}>
                                        <li>
                                            JSONPath roots MUST be a known envelope
                                            slot. <code>$.input.x</code> is rejected
                                            with a "did you mean inputs?" suggestion.
                                        </li>
                                        <li>
                                            Empty segments (
                                            <code>$.inputs..country</code>) are
                                            rejected with a duplicated-separator hint.
                                        </li>
                                        <li>
                                            Plain flat names are permissive — the
                                            registry can't validate them structurally
                                            without more context (which is what gap-08
                                            adds via the schema entity).
                                        </li>
                                    </ul>
                                </>
                            ),
                        },
                        {
                            ...
                            detail: (
                                <>
                                    Gap-05's literal-key-first templating story uses
                                    the same parser. Gap-08's per-variable tooltip
                                    extends the existing invalid-token mechanism to
                                    "valid syntax but not in the attached testset's
                                    schema" once the schema entity (gap-07) lands.
                                </>
                            ),
                        },
                    ]}
                    ...
                    items={[
                        {
                            ...
                            detail: (
                                <>
                                    The right-side panel listing "discovered from
                                    prompt" + "available from testcase context" +
                                    "available from trace context" exists only as a
                                    wireframe in{" "}
                                    <code>
                                        docs/designs/json-string-ux/archive/05-playground-variables.md
                                    </code>
                                    . Not built. Most of what gap-08's banner +
                                    tooltip propose lives in this archived doc.
                                </>
                            ),
                        },
                        {
                            ...
                            detail: (
                                <>
                                    ...
                                    <Link
                                        href="/gap-07-schema-aware-form"
                                        style={styles.link}
                                    >
                                        gap-07
                                    </Link>{" "}
                                    (per-testset schema entity). Without it, the
                                    typeahead can validate envelope slots but not
                                    flat-name references against the actual data
                                    contract.
                                </>
                            ),
                        },
                        {
                            ...
                            detail: (
                                <>
                                    ...
                                    . The chain context + token suggestions are the
                                    inputs; the rendering proposed there is new.
                                </>
                            ),
                        },
                    ]}
