...
|---|---|---|
| `agenta-sdk` | Hand-rolled HTTP client + 22 resource classes + Zod boundary validation + retry logic + typed error hierarchy | Replaced by Fern-generated `@agenta/client` consumed by the new thin `@agenta/sdk` |
