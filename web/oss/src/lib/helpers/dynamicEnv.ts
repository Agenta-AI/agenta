export const processEnv = {
    ...
    NEXT_PUBLIC_PLAYGROUND_EVALUATOR_LEGACY: process.env.NEXT_PUBLIC_PLAYGROUND_EVALUATOR_LEGACY,
    NEXT_PUBLIC_PLAYGROUND_EVALUATOR_WORKFLOWS:
        process.env.NEXT_PUBLIC_PLAYGROUND_EVALUATOR_WORKFLOWS,
