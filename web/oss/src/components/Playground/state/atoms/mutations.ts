...
export const setDisplayedVariantsMutationAtom = atom(null, (get, set, variantIds: string[]) => {
    ...
    // NOTE: No manual sync needed - autoSyncedGenerationDataAtom handles this automatically
    // When selectedVariantsAtom updates, displayedVariantsAtom recomputes,
    // which triggers displayedVariantsVariablesAtom and autoSyncedGenerationDataAtom to update
})
