...
const PlaygroundDerivedListener = () => {
    ...
    // Removed legacy bypass flow. We now listen for revisions and react when available.
    ...
    useEffect(() => {
        ...
        if (newUrlRevisions.length > 0 && !deepEqual(newUrlRevisions, urlRevisions)) {
            console.log("🔗 [PlaygroundDerivedListener] Syncing URL revisions:", newUrlRevisions)
