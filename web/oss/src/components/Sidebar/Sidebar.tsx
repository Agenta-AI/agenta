...
import SidePanelUpdates from "@/oss/components/SidePanel/Updates"
                        ...
                        <div>
                            ...
                            <div>
                                <SidePanelSubscriptionInfo
                                    ...
                                    isHovered={isHovered}
                                />
                                {/* Displays update notifications from the changelog */}
                                <SidePanelUpdates collapsed={collapsed} isHovered={isHovered} />
                                <SidebarMenu
                                    menuProps={{
