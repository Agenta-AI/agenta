        ...
        return (
            ...
            >
                <Tooltip title={open ? undefined : "Add property"}>
                    <button
                        type="button"
                        className="flex items-center justify-center w-6 h-6 rounded border-none cursor-pointer transition-colors bg-transparent text-[rgba(0,0,0,0.45)] hover:text-[var(--ag-c-1C2C3D)] hover:bg-[rgba(0,0,0,0.06)]"
                    >
                        <Plus size={14} />
                    </button>
                </Tooltip>
