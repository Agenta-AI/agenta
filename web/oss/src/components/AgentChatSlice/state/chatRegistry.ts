...
/** Per-mount callbacks, rebound on every acquire so a preserved chat never runs stale closures. */
 ...
 * existing one already holds the authoritative, possibly mid-stream transcript.
 */
