                ...
                (event: KeyboardEvent) => {
                    ...
                    // This ensures proper indentation for JSON objects, arrays, and code blocks
                        ...
                        if (emptyHighlightNode) {
                            ...
                            const tabNodes = trailing.getChildren().filter($isCodeTabNode)
                    ...
                    const firstContentNode = targetChildren.find((node) => !$isCodeTabNode(node))
                    const lastTabNode = targetChildren.filter($isCodeTabNode).pop()
