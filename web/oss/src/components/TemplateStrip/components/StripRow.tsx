...
const StripRow = ({
    ...
    <button
        ...
        className={`group box-border flex w-full cursor-pointer items-start gap-3 border-0 border-b border-solid border-colorBorderSecondary px-2 py-2.5 text-left last:border-b-0 ${
            selected
    ...
    >
        ...
        <span className="flex min-w-0 flex-1 flex-col gap-0.5">
            <span className="flex items-center gap-2">
                <span className="min-w-0 flex-1 truncate text-xs font-medium text-colorText">
                    {template.name}
                </span>
            ...
            <span className="line-clamp-2 text-[11px] leading-snug text-colorTextSecondary">
