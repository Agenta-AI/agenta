...
const AgentRow = ({
    ...
    <div
        ...
        className="group box-border flex w-full cursor-pointer items-center gap-2 border-0 border-b border-solid border-colorBorderSecondary px-2 py-3 text-left last:border-b-0 hover:bg-colorFillQuaternary"
    >
