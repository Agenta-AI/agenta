...
const FocusDrawerHeader = ({runId, scenarioId}: FocusDrawerHeaderProps) => {
    ...
    const handlePrev = useCallback(() => {
        ...
        patchFocusDrawerQueryParams({focusRunId: runId, focusScenarioId: target.scenarioId})
    }, [currentIndex, loadedScenarios, runId])
