...
import {Environment, PlaygroundTabsItem, Variant} from "@/oss/lib/Types"
import {fetchVariants} from "@/oss/services/api"
import {fetchEnvironments} from "@/oss/services/deployment/api"
import {createNewVariant} from "@/oss/services/playground/api"
...
const Playground: React.FC = () => {
    ...
    const [unsavedVariants, setUnsavedVariants] = useState<Record<string, boolean>>({})
    const variantHelpers = useRef<Record<string, {save: Function; delete: Function}>>({})
