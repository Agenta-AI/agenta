...
import {Button, Col, Divider, notification, Row, Tooltip, Typography} from "antd"
...
import {useLegacyVariant} from "@/oss/lib/hooks/useLegacyVariant"
import {Environment, Variant} from "@/oss/lib/Types"
import {fetchAppContainerURL, waitForAppToStart} from "@/oss/services/api"
import {deleteSingleVariant, restartAppVariantContainer} from "@/oss/services/playground/api"
...
const ViewNavigation: React.FC<Props> = ({
    ...
    if (isError) {
        ...
        const appName = currentApp?.app_name || ""
        ...
        const variantContainerPath = async () => {
            console.log("variantContainerPath !!")
