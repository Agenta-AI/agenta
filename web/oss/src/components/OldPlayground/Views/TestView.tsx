...
import TraceContent from "@/oss/components/pages/observability/drawer/TraceContent"
import TraceHeader from "@/oss/components/pages/observability/drawer/TraceHeader"
import TraceTree from "@/oss/components/pages/observability/drawer/TraceTree"
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                ...
                if (!mod || !mod?.fetchPromptRevision) return

                const revision = await mod.fetchPromptRevision(
                    variant.variantId,
