...
// The picker carries the virtualizer, the colour maths and an 880 KB lazy catalog. Only this
...
const DEFAULT_CHIP = "bg-[var(--ag-type-agent-bg)] text-[var(--ag-type-agent-text)]"
...
export const AgentIconTrigger = ({workflowId}: {workflowId: string | null}) => {
    ...
    const chrome = useAgentIconChrome(workflowId, {
        size: 15,
        fallbackGlyph: <RobotIcon size={15} />,
