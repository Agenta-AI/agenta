...
import {fileTypeLabel, resolveDriveFileKind, type DriveFileKind} from "./renderers"
...
export function DriveFileMetaList({
    ...
    return (
        ...
        // auto-flow) — keeps the metadata block compact so the file content sits higher.
        <dl className="grid grid-cols-[auto_1fr_auto_1fr] gap-x-4 gap-y-1.5 text-[11px]">
