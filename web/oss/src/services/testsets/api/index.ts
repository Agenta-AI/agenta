...
export const fetchPreviewTestsets = async (payload: PreviewTestsetsQueryPayload = {}) => {
    ...
    const response = await axios.post(
        `${getAgentaApiUrl()}/simple/testsets/query?project_id=${projectId}`,
        payload,
    )
...
export async function fetchSimpleTestset(testsetId: string) {
    ...
    const response = await axios.get(
        `${getAgentaApiUrl()}/simple/testsets/${testsetId}?project_id=${projectId}`,
    )
...
export const uploadTestsetPreview = async (
    ...
    const response = await axios.post(
        `${getAgentaApiUrl()}/simple/testsets/upload?project_id=${projectId}`,
        formData,
        {
            headers: {
...
export const uploadTestsetRevisionPreview = async (
    ...
    const response = await axios.post(
        `${getAgentaApiUrl()}/simple/testsets/${testsetId}/upload?project_id=${projectId}`,
        formData,
        {
            headers: {
                "Content-Type": "multipart/form-data",
