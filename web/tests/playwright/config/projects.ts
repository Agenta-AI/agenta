...
import {TestEnvironment, TestFeatureScope, environmentFeatures} from "./testTags"
 ...
 */
const createFeaturePattern = (features: PlaywrightConfig.TestFeatureScopeType[]): RegExp =>
 ...
 */
const createCloudOnlyVariant = (env: PlaywrightConfig.TestEnvironmentType): Project | null => {
...
const cloudOnlyProjects = Object.keys(TestEnvironment)
    .map((env) => createCloudOnlyVariant(env as PlaywrightConfig.TestEnvironmentType))
