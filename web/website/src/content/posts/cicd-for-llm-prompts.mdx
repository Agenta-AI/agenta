...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td>Write code in an IDE</td>
      <td>Write prompts in a playground or management UI</td>
    </tr>
    <tr>
      <td>
        <strong>Version</strong>
      </td>
      <td>Git commits and branches</td>
      <td>Prompt versions and variants</td>
    </tr>
    <tr>
      <td>
        <strong>Test</strong>
      ...
      <td>Evaluation against test sets (automated scoring)</td>
    </tr>
    <tr>
      <td>
      ...
      <td>Side-by-side comparison of prompt versions, human review</td>
    </tr>
    <tr>
      <td>
        <strong>Stage</strong>
      ...
      <td>Deploy prompt to staging environment</td>
    </tr>
    <tr>
      <td>
      ...
      <td>Deploy prompt to production environment</td>
    </tr>
    <tr>
      <td>
      ...
      <td>LLM observability (cost, latency, output quality per version)</td>
    </tr>
  </tbody>
</table>
...
<table>
  <tbody>
    ...
    <tr>
      <td>
        <strong>Deploy speed</strong>
      </td>
      <td>Instant (on next fetch)</td>
      <td>Instant</td>
      <td>Minutes (PR + merge + deploy)</td>
    </tr>
    <tr>
      <td>
        <strong>Code change required</strong>
      </td>
      <td>No</td>
      <td>No</td>
      <td>Yes (automated PR)</td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      <td>
        <strong>Added latency</strong>
      </td>
      <td>None (with caching)</td>
      <td>~300ms per call</td>
      <td>None</td>
    </tr>
    <tr>
      <td>
      ...
      <td>Fast iteration teams</td>
      <td>Simple integration</td>
      <td>Regulated / Git-first teams</td>
    </tr>
  </tbody>
</table>
