...
**Context Recall** measures the proportion of relevant documents that were successfully retrieved, emphasizing completeness. Higher recall indicates fewer missed relevant pieces. Because it assesses what was _not_ left out, calculating context recall always requires a reference set for comparison.
