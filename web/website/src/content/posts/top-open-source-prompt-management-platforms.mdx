...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td>Collaboration &amp; Full Lifecycle</td>
      <td>Observability &amp; DevEx</td>
      <td>AI Observability &amp; Evaluation</td>
      <td>AI Agents &amp; Prompt Engineering</td>
      <td>Cloud-Native Delivery &amp; Cost</td>
    </tr>
    <tr>
      <td>
        <strong>Versioning</strong>
      </td>
      <td>Git-like (Variants &amp; Commits)</td>
      <td>Linear (Versions &amp; Labels)</td>
      <td>Linear (Tags)</td>
      <td>Version Control</td>
      <td>Commit &amp; Publish</td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        <strong>Excellent</strong> (UI for non-devs)
      </td>
      <td>Good (UI for editing)</td>
      <td>Fair (Developer-focused)</td>
      <td>Good (Team workflows)</td>
      <td>Fair (Developer-first)</td>
    </tr>
    <tr>
      <td>
        <strong>Evaluation</strong>
      </td>
      <td>Integrated (Auto, Human, Online)</td>
      <td>Integrated (LLM-as-judge)</td>
      <td>
        <strong>Excellent</strong> (Prompt Learning)
      </td>
      <td>Integrated (Built-in, HITL)</td>
      <td>Limited</td>
    </tr>
    <tr>
      <td>
      ...
      <td>Elastic License 2.0 (Non-OSI)</td>
      <td>LGPL-3.0 (Copyleft)</td>
      <td>Apache 2.0</td>
    </tr>
  </tbody>
</table>
