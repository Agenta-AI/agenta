...
function css(value) {
    ...
    const font = result.font?.match(/^(\d+)\s+([\d.]+px)\/([\d.]+(?:px)?)\s+(.+)$/)
    if (font) {
...
export default class WorkspaceDemo extends Component {
    ...
    onEscape = (event) => {
        if (event.key === "Escape" && this.state.skill !== null) this.setState({skill: null})
    }
    componentDidUpdate(_, previous) {
        ...
        } else if (previous.skill !== null && this.state.skill === null) this.returnFocus?.focus()
    }
    state = {
        view: "home",
        session: null,
        ...
        return (
            ...
            >
                <nav className="ag-demo-mobile-nav" aria-label="Demo screens">
                    {["home", "agents", "automations", "skills", "sessions"].map((name) => (
                        <button
                            key={name}
                            type="button"
                ...
                >
                    ...
                    >
                        <button type={`button`} onClick={nav.home.go} style={css(nav.home.style)}>
                            <span style={css(`display:flex;flex:0 0 auto;align-items:center;`)}>
                                <svg
                                    width={`16`}
                                    height={`16`}
                                    viewBox={`0 0 256 256`}
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <div
                                                    style={css(
                                                        `color:var(--foreground);max-width:72ch;`,
                                                    )}
                                                >
                                                    {ss.reply}
                                                </div>
