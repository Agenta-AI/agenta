...
const SCENARIO_METRIC_ALIASES: Record<string, string[]> = {
...
const extractSchemaProperties = (entry: any): Record<string, any> | undefined => {
    if (!entry || typeof entry !== "object") return undefined
    const candidates = [
...
const resolveEvaluatorMetricsMap = (entry: any): Record<string, any> | undefined => {
    if (!entry || typeof entry !== "object") return undefined
...
const DrawerMetricValueCell = ({
    ...
    const tagNode = (
        <Tag
            className={clsx("bg-[#0517290F] hover:bg-[#05172916]", {
