...
import {statusColorMap} from "../assets/helpers"
...
const EvalRunScenarioNavigator = ({
    ...
    const handleSelect = useCallback(
        (newId: string) => {
            if (router.query.scenarioId !== newId) {
                router.replace(
                    {
                        pathname: router.pathname,
                        query: {...router.query, scenarioId: newId},
                    },
                    undefined,
                    {shallow: false},
                )
    ...
    }, [handlePrevNext, prevDisabled, nextDisabled, activeId, isRunning, isDone, enqueueScenario])
