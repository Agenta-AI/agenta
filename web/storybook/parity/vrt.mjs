...
const DEFAULT_STORIES = [
    ...
    // entity-ui wave 1. Parity exports gate; data-seam showcases are NO_PAIR entries below.
    // Excluded on purpose: `additemmenu--playground` (interactive arg playground).
    // Wave 2 — DrillInView. `--antd-vs-agenta` / `--open-state` gate; the rest are
    // state showcases declared in NO_PAIR_EXPECTED below.
    "agenta-entity-ui-drillin-addtriggerdropdown--antd-vs-agenta",
    "agenta-entity-ui-drillin-advancedconfigfields--antd-vs-agenta",
    "agenta-entity-ui-drillin-claudepermissionscontrol--antd-vs-agenta",
    "agenta-entity-ui-drillin-configitemdrawer--antd-vs-agenta",
    "agenta-entity-ui-drillin-configsectionheader--antd-vs-agenta",
    "agenta-entity-ui-drillin-configurepopover--antd-vs-agenta",
    "agenta-entity-ui-drillin-fallbackconfigtab--antd-vs-agenta",
    "agenta-entity-ui-drillin-feedbackconfigurationcontrol--antd-vs-agenta",
    "agenta-entity-ui-drillin-harnessselectcontrol--antd-vs-agenta",
    "agenta-entity-ui-drillin-instructionsdrawer--antd-vs-agenta",
    "agenta-entity-ui-drillin-leafcontrols--antd-vs-agenta",
    "agenta-entity-ui-drillin-markdowneditor--antd-vs-agenta",
    "agenta-entity-ui-drillin-mcpserverformview--antd-vs-agenta",
    "agenta-entity-ui-drillin-mcpserveritemcontrol--antd-vs-agenta",
    "agenta-entity-ui-drillin-messagesschemacontrol--antd-vs-agenta",
    "agenta-entity-ui-drillin-modelconfigeditor--antd-vs-agenta",
    "agenta-entity-ui-drillin-objectschemacontrol--antd-vs-agenta",
    "agenta-entity-ui-drillin-promptschemacontrol--antd-vs-agenta",
    "agenta-entity-ui-drillin-referencetoolformview--antd-vs-agenta",
    "agenta-entity-ui-drillin-responseformatcontrol--antd-vs-agenta",
    "agenta-entity-ui-drillin-retryconfigtab--antd-vs-agenta",
    "agenta-entity-ui-drillin-sandboxpermissioncontrol--antd-vs-agenta",
    "agenta-entity-ui-drillin-schemapropertyrenderer--antd-vs-agenta",
    "agenta-entity-ui-drillin-schemasconfigcontrol--antd-vs-agenta",
    "agenta-entity-ui-drillin-schematree--antd-vs-agenta",
    "agenta-entity-ui-drillin-skilltemplatecontrol--antd-vs-agenta",
    "agenta-entity-ui-drillin-skilluploadzone--antd-vs-agenta",
    "agenta-entity-ui-drillin-subscriptionchildrow--antd-vs-agenta",
    "agenta-entity-ui-drillin-subscriptionchildrow--open-state",
    "agenta-entity-ui-drillin-toolitemcontrol--antd-vs-agenta",
    "agenta-entity-ui-drillin-toolselectorpopover--antd-vs-agenta",
    "agenta-entity-ui-drillin-toolselectorpopover--open-state",
    "agenta-entity-ui-drillin-toolselectorpopover--open-state-with-gateway",
    "agenta-entity-ui-drillin-triggerrow--antd-vs-agenta",
    "agenta-entity-ui-drillin-triggerrow--open-state",
    "agenta-entity-ui-drillin-workflowreferenceselector--antd-vs-agenta",
    "agenta-entity-ui-drillin-advancedconfigfields--collapsed",
    "agenta-entity-ui-drillin-advancedconfigfields--expanded",
    "agenta-entity-ui-drillin-claudepermissionscontrol--default",
    "agenta-entity-ui-drillin-claudepermissionscontrol--disabled",
    "agenta-entity-ui-drillin-claudepermissionscontrol--empty",
    "agenta-entity-ui-drillin-claudepermissionscontrol--schema-driven-modes",
    "agenta-entity-ui-drillin-configitemdrawer--content-flush",
    "agenta-entity-ui-drillin-configitemdrawer--create-mode",
    "agenta-entity-ui-drillin-configitemdrawer--default",
    "agenta-entity-ui-drillin-configitemdrawer--json-only",
    "agenta-entity-ui-drillin-configitemdrawer--save-disabled",
    "agenta-entity-ui-drillin-configitemdrawer--view-only",
    "agenta-entity-ui-drillin-configsectionheader--code",
    "agenta-entity-ui-drillin-configsectionheader--feedback",
    "agenta-entity-ui-drillin-configsectionheader--prompt",
    "agenta-entity-ui-drillin-configurepopover--default",
    "agenta-entity-ui-drillin-configurepopover--disabled",
    "agenta-entity-ui-drillin-configurepopover--single-tab",
    "agenta-entity-ui-drillin-fallbackconfigtab--disabled",
    "agenta-entity-ui-drillin-fallbackconfigtab--no-policy",
    "agenta-entity-ui-drillin-fallbackconfigtab--with-models",
    "agenta-entity-ui-drillin-feedbackconfigurationcontrol--advanced-mode",
    "agenta-entity-ui-drillin-feedbackconfigurationcontrol--boolean-format",
    "agenta-entity-ui-drillin-feedbackconfigurationcontrol--categorical-format",
    "agenta-entity-ui-drillin-feedbackconfigurationcontrol--continuous-format",
    "agenta-entity-ui-drillin-feedbackconfigurationcontrol--disabled",
    "agenta-entity-ui-drillin-harnessselectcontrol--default",
    "agenta-entity-ui-drillin-harnessselectcontrol--disabled",
    "agenta-entity-ui-drillin-harnessselectcontrol--placeholder",
    "agenta-entity-ui-drillin-harnessselectcontrol--restricted-values",
    "agenta-entity-ui-drillin-instructionsdrawer--default",
    "agenta-entity-ui-drillin-instructionsdrawer--disabled",
    "agenta-entity-ui-drillin-instructionsdrawer--other-file",
    "agenta-entity-ui-drillin-leafcontrols--code-config",
    "agenta-entity-ui-drillin-leafcontrols--disabled-states",
    "agenta-entity-ui-drillin-leafcontrols--hook-config",
    "agenta-entity-ui-drillin-leafcontrols--json-editor",
    "agenta-entity-ui-drillin-leafcontrols--operations-skeleton",
    "agenta-entity-ui-drillin-leafcontrols--provider-groups",
    "agenta-entity-ui-drillin-leafcontrols--quick-action",
    "agenta-entity-ui-drillin-leafcontrols--section-drawer-open",
    "agenta-entity-ui-drillin-markdowneditor--default",
    "agenta-entity-ui-drillin-markdowneditor--disabled",
    "agenta-entity-ui-drillin-markdowneditor--no-filename",
    "agenta-entity-ui-drillin-markdowneditor--preview",
    "agenta-entity-ui-drillin-markdowneditor--with-toolbar",
    "agenta-entity-ui-drillin-mcpserverformview--invalid-name",
    "agenta-entity-ui-drillin-mcpserverformview--no-auth",
    "agenta-entity-ui-drillin-mcpserverformview--no-project-secrets",
    "agenta-entity-ui-drillin-mcpserverformview--secret-header",
    "agenta-entity-ui-drillin-mcpserveritemcontrol--read-only",
    "agenta-entity-ui-drillin-messagesschemacontrol--default",
    "agenta-entity-ui-drillin-messagesschemacontrol--disabled-empty",
    "agenta-entity-ui-drillin-messagesschemacontrol--no-label",
    "agenta-entity-ui-drillin-messagesschemacontrol--with-description",
    "agenta-entity-ui-drillin-modelconfigeditor--default",
    "agenta-entity-ui-drillin-modelconfigeditor--disabled",
    "agenta-entity-ui-drillin-objectschemacontrol--collapsible",
    "agenta-entity-ui-drillin-objectschemacontrol--disabled-inline",
    "agenta-entity-ui-drillin-objectschemacontrol--inline",
    "agenta-entity-ui-drillin-objectschemacontrol--no-header",
    "agenta-entity-ui-drillin-objectschemacontrol--no-properties",
    "agenta-entity-ui-drillin-objectschemacontrol--no-renderer",
    "agenta-entity-ui-drillin-objectschemacontrol--tool-configuration",
    "agenta-entity-ui-drillin-promptschemacontrol--default",
    "agenta-entity-ui-drillin-promptschemacontrol--disabled",
    "agenta-entity-ui-drillin-promptschemacontrol--no-messages-field",
    "agenta-entity-ui-drillin-referencetoolformview--disabled",
    "agenta-entity-ui-drillin-responseformatcontrol--atom-driven-modal",
    "agenta-entity-ui-drillin-responseformatcontrol--disabled",
    "agenta-entity-ui-drillin-responseformatcontrol--json-object-format",
    "agenta-entity-ui-drillin-responseformatcontrol--json-schema-format",
    "agenta-entity-ui-drillin-responseformatcontrol--json-schema-unnamed",
    "agenta-entity-ui-drillin-responseformatcontrol--schema-modal-open",
    "agenta-entity-ui-drillin-responseformatcontrol--text-format",
    "agenta-entity-ui-drillin-retryconfigtab--disabled",
    "agenta-entity-ui-drillin-retryconfigtab--retries-off",
    "agenta-entity-ui-drillin-retryconfigtab--retries-on",
    "agenta-entity-ui-drillin-sandboxpermissioncontrol--allowlist-mode",
    "agenta-entity-ui-drillin-sandboxpermissioncontrol--default",
    "agenta-entity-ui-drillin-sandboxpermissioncontrol--disabled",
    "agenta-entity-ui-drillin-schemapropertyrenderer--composite-branches",
    "agenta-entity-ui-drillin-schemapropertyrenderer--disabled",
    "agenta-entity-ui-drillin-schemapropertyrenderer--scalar-branches",
    "agenta-entity-ui-drillin-schemasconfigcontrol--default",
    "agenta-entity-ui-drillin-schemasconfigcontrol--disabled",
    "agenta-entity-ui-drillin-schemasconfigcontrol--empty-value",
    "agenta-entity-ui-drillin-schematree--empty",
    "agenta-entity-ui-drillin-schematree--flat",
    "agenta-entity-ui-drillin-schematree--nested",
    "agenta-entity-ui-drillin-schematree--no-schema",
    "agenta-entity-ui-drillin-skillformview--default",
    "agenta-entity-ui-drillin-skillformview--disabled",
    "agenta-entity-ui-drillin-skillformview--with-files",
    "agenta-entity-ui-drillin-toolformview--disabled",
    "agenta-entity-ui-drillin-toolformview--function-tool",
    "agenta-entity-ui-drillin-toolformview--gateway-tool-without-schema",
    "agenta-entity-ui-drillin-toolformview--reference-tool",
    "agenta-entity-ui-drillin-toolitemcontrol--read-only",
    "agenta-entity-ui-drillin-triggermanagementsection--empty",
    "agenta-entity-ui-drillin-triggermanagementsection--read-only",
    "agenta-entity-ui-drillin-triggermanagementsection--with-triggers",
    "agenta-entity-ui-drillin-workflowreferenceselector--default",
    "agenta-entity-ui-drillin-workflowreferenceselector--empty-list",
    "agenta-entity-ui-drillin-workflowreferenceselector--loading",
    // Wave 2 round 2 — agentTemplate family.
    "agenta-entity-ui-drillin-agentconfigskeleton--antd-vs-agenta",
    "agenta-entity-ui-drillin-agentintegrationdrawer--antd-vs-agenta",
    "agenta-entity-ui-drillin-agentintegrationdrawer--open-state",
    "agenta-entity-ui-drillin-agenttemplatecontrol--antd-vs-agenta",
    "agenta-entity-ui-drillin-agenttoolselectorpopover--antd-vs-agenta",
    "agenta-entity-ui-drillin-agenttoolselectorpopover--open-state",
    "agenta-entity-ui-drillin-buildkitsection--antd-vs-agenta",
    "agenta-entity-ui-drillin-catalogunavailablenotice--antd-vs-agenta",
    "agenta-entity-ui-drillin-itemrow--antd-vs-agenta",
    "agenta-entity-ui-drillin-parameternodeeditor--antd-vs-agenta",
    "agenta-entity-ui-drillin-parametertree--antd-vs-agenta",
    "agenta-entity-ui-drillin-permissionpolicyselect--antd-vs-agenta",
    "agenta-entity-ui-drillin-permissionpolicyselect--open-state",
    "agenta-entity-ui-drillin-providercredentialssection--antd-vs-agenta",
    "agenta-entity-ui-drillin-providerkeyfield--antd-vs-agenta",
    "agenta-entity-ui-drillin-revertgroupbutton--antd-vs-agenta",
    "agenta-entity-ui-drillin-revertgroupbutton--open-state",
    "agenta-entity-ui-drillin-agentconfigskeleton--in-panel",
    "agenta-entity-ui-drillin-agentintegrationdrawer--open-on-integration",
    "agenta-entity-ui-drillin-agenttemplatecontrol--blank",
    "agenta-entity-ui-drillin-agenttemplatecontrol--catalog-unavailable",
    "agenta-entity-ui-drillin-agenttemplatecontrol--configured",
    "agenta-entity-ui-drillin-agenttemplatecontrol--disabled",
    "agenta-entity-ui-drillin-agenttemplatecontrol--empty-schema",
    "agenta-entity-ui-drillin-agenttemplatecontrol--section-list",
    "agenta-entity-ui-drillin-agenttemplatecontrol--section-list-empty",
    "agenta-entity-ui-drillin-agenttoolselectorpopover--create-only",
    "agenta-entity-ui-drillin-buildkitsection--default",
    "agenta-entity-ui-drillin-buildkitsection--disabled",
    "agenta-entity-ui-drillin-buildkitsection--kit-off",
    "agenta-entity-ui-drillin-buildkitsection--override-hint",
    "agenta-entity-ui-drillin-buildkitsection--permissions-only",
    "agenta-entity-ui-drillin-catalogunavailablenotice--default",
    "agenta-entity-ui-drillin-itemrow--section-stack",
    "agenta-entity-ui-drillin-parameternodeeditor--array-of-object",
    "agenta-entity-ui-drillin-parameternodeeditor--boolean-node",
    "agenta-entity-ui-drillin-parameternodeeditor--deep-path",
    "agenta-entity-ui-drillin-parameternodeeditor--disabled",
    "agenta-entity-ui-drillin-parameternodeeditor--enum-scalar",
    "agenta-entity-ui-drillin-parameternodeeditor--integer-scalar",
    "agenta-entity-ui-drillin-parameternodeeditor--object-node",
    "agenta-entity-ui-drillin-parameternodeeditor--scalar-array",
    "agenta-entity-ui-drillin-parameternodeeditor--string-scalar",
    "agenta-entity-ui-drillin-parametertree--array-of-object",
    "agenta-entity-ui-drillin-parametertree--deep-nesting",
    "agenta-entity-ui-drillin-parametertree--disabled",
    "agenta-entity-ui-drillin-parametertree--empty-schema",
    "agenta-entity-ui-drillin-parametertree--meta-selected",
    "agenta-entity-ui-drillin-parametertree--nested-object",
    "agenta-entity-ui-drillin-parametertree--scalar-arrays",
    "agenta-entity-ui-drillin-parametertree--scalar-properties",
    "agenta-entity-ui-drillin-permissionpolicyselect--default",
    "agenta-entity-ui-drillin-permissionpolicyselect--disabled",
    "agenta-entity-ui-drillin-permissionpolicyselect--narrowed-by-schema",
    "agenta-entity-ui-drillin-providercredentialssection--bare",
    "agenta-entity-ui-drillin-providercredentialssection--custom-connection",
    "agenta-entity-ui-drillin-providercredentialssection--default",
    "agenta-entity-ui-drillin-providercredentialssection--disabled",
    "agenta-entity-ui-drillin-providercredentialssection--needs-key",
    "agenta-entity-ui-drillin-providercredentialssection--self-managed",
    "agenta-entity-ui-drillin-providercredentialssection--self-managed-on-cloud",
    "agenta-entity-ui-drillin-providerkeyfield--configured",
    "agenta-entity-ui-drillin-providerkeyfield--default",
    "agenta-entity-ui-drillin-providerkeyfield--disabled",
    "agenta-entity-ui-drillin-providerkeyfield--hide-header",
    "agenta-entity-ui-drillin-revertgroupbutton--confirming",
    "agenta-entity-ui-drillin-revertgroupbutton--default",
    "agenta-entity-ui-drillin-revertgroupbutton--disabled",
    "agenta-entity-ui-domain-variantnamecell--default",
    "agenta-entity-ui-domain-variantnamecell--deployed",
    "agenta-entity-ui-domain-variantnamecell--named-variant",
    "agenta-entity-ui-domain-variantnamecell--no-data",
    "agenta-entity-ui-domain-variantnamecell--not-latest",
    "agenta-entity-ui-drawers-additemmenu--antd-vs-agenta",
    "agenta-entity-ui-drawers-catalogappcard--antd-vs-agenta",
    "agenta-entity-ui-drawers-catalogchooser--browse",
    "agenta-entity-ui-drawers-catalogchooser--connection-detail",
    "agenta-entity-ui-drawers-catalogchooser--no-connections",
    "agenta-entity-ui-drawers-drawerfooter--antd-vs-agenta",
    "agenta-entity-ui-drawers-gatewaycatalogdrawer--showcase",
    "agenta-entity-ui-drawers-masterdetailrail--antd-vs-agenta",
    "agenta-entity-ui-drawers-railfield--antd-vs-agenta",
    "agenta-entity-ui-drawers-sectionrail--antd-vs-agenta",
    "agenta-entity-ui-gatewaytool-catalogdrawer--open",
    "agenta-entity-ui-gatewaytool-catalogdrawer--empty",
    "agenta-entity-ui-gatewaytool-connectionmanagerdrawer--connected",
    "agenta-entity-ui-gatewaytool-connectionmanagerdrawer--pending",
    "agenta-entity-ui-gatewaytool-connectionmanagerdrawer--not-found",
    "agenta-entity-ui-gatewaytool-connectionstatusbadge--antd-vs-agenta",
    "agenta-entity-ui-gatewaytool-resultviewer--antd-vs-agenta",
    "agenta-entity-ui-gatewaytool-resultviewer--fields",
    "agenta-entity-ui-gatewaytool-schemaform--antd-vs-agenta",
    "agenta-entity-ui-gatewaytool-schemaform--default",
    "agenta-entity-ui-gatewaytool-schemaform--open-enums",
    "agenta-entity-ui-gatewaytool-schemaform--stepper",
    "agenta-entity-ui-gatewaytool-schemaform--disabled",
    "agenta-entity-ui-gatewaytrigger-activetoggle--antd-vs-agenta",
    "agenta-entity-ui-gatewaytrigger-eventsourcepicker--open-state",
    "agenta-entity-ui-gatewaytrigger-eventsourcepicker--open-state-empty",
    "agenta-entity-ui-gatewaytrigger-messagecomposer--antd-vs-agenta",
    "agenta-entity-ui-gatewaytrigger-runbuttons--antd-vs-agenta",
    "agenta-entity-ui-gatewaytrigger-schedulebuilderfield--antd-vs-agenta",
    "agenta-entity-ui-gatewaytrigger-windowfield--antd-vs-agenta",
    "agenta-entity-ui-modals-entitycommitmodal--clean-revision",
    "agenta-entity-ui-modals-entitycommitmodal--agent-changes",
    "agenta-entity-ui-modals-entitycommitmodal--create-flow",
    "agenta-entity-ui-modals-entitycommitmodal--error-state",
    "agenta-entity-ui-modals-entitycommitmodal--no-data",
    "agenta-entity-ui-modals-entitydeletemodal--default",
    "agenta-entity-ui-modals-entitydeletemodal--adapter-resolved-names",
    "agenta-entity-ui-modals-entitydeletemodal--blocked-and-warnings",
    "agenta-entity-ui-modals-entitydeletemodal--error-state",
    "agenta-entity-ui-modals-entitysavemodal--save-existing",
    "agenta-entity-ui-modals-entitysavemodal--save-as-new",
    "agenta-entity-ui-modals-entitysavemodal--new-entity",
    "agenta-entity-ui-modals-entitysavemodal--error-state",
    "agenta-entity-ui-modals-loadevaluatorpresetmodal--default",
    "agenta-entity-ui-modals-loadevaluatorpresetmodal--empty",
    "agenta-entity-ui-secretprovider-customproviderform--new-provider",
    "agenta-entity-ui-secretprovider-customproviderform--preselected-kind",
    "agenta-entity-ui-secretprovider-customproviderform--edit-provider",
    "agenta-entity-ui-secretprovider-customproviderform--validation-errors",
    "agenta-entity-ui-secretprovider-modelnameinput--antd-vs-agenta",
    "agenta-entity-ui-selection-entityselectormodal--open",
    "agenta-entity-ui-selection-unifiedentitypicker--breadcrumb",
    "agenta-entity-ui-selection-unifiedentitypicker--cascader",
    "agenta-entity-ui-selection-unifiedentitypicker--cascading",
    "agenta-entity-ui-selection-unifiedentitypicker--list-popover",
    "agenta-entity-ui-selection-unifiedentitypicker--popover-cascader",
    "agenta-entity-ui-shared-entitytable--multi-select",
    "agenta-entity-ui-shared-entitytable--single-select",
    "agenta-entity-ui-shared-entitytable--selection-disabled",
    "agenta-entity-ui-shared-entitytable--view-only",
    "agenta-entity-ui-shared-runnableoutputvalue--antd-vs-agenta",
    "agenta-entity-ui-shared-sharedgenerationresultutils--success",
    "agenta-entity-ui-shared-sharedgenerationresultutils--error-status",
    "agenta-entity-ui-shared-sharedgenerationresultutils--actions-only",
    "agenta-entity-ui-shared-sharedgenerationresultutils--no-handler",
    "agenta-entity-ui-shared-sharedgenerationresultutils--pending",
    "agenta-entity-ui-templateformat-templateformatpicker--antd-vs-agenta",
    "agenta-entity-ui-testcase-testcasedrawer--default",
    "agenta-entity-ui-testcase-testcasedrawer--loading",
    "agenta-entity-ui-testcase-testcasedrawer--error-state",
    "agenta-entity-ui-testcase-testcasedrawer--view-only",
    "agenta-entity-ui-variant-environmentstatus--antd-vs-agenta",
    "agenta-entity-ui-variant-variantdetails--antd-vs-agenta",
    "agenta-entity-ui-viewtypes-formview--antd-vs-agenta",
    "agenta-entity-ui-viewtypes-formview--showcase",
    "agenta-entity-ui-workflow-workflowkindtag--antd-vs-agenta",
    "agenta-entity-ui-workflow-workflowtypetag--antd-vs-agenta",
    "agenta-entity-ui-workflow-workflowtypetag--evaluator-from-template",
...
const NO_PAIR_EXPECTED = new Map([
    ...
    // entity-ui wave 1 data-seam showcases: the component replaced its antd ancestor, so
    // these exports render only the migrated version (state/fixture coverage, not parity).
    // The files' antd imports/captions belong to their `--antd-vs-agenta` exports, which gate.
    ...[
        "agenta-entity-ui-domain-variantnamecell--default",
        "agenta-entity-ui-domain-variantnamecell--deployed",
        "agenta-entity-ui-domain-variantnamecell--named-variant",
    ...
    ...[
        ...
        "agenta-entity-ui-drillin-workflowreferenceselector--empty-list",
        "agenta-entity-ui-drillin-workflowreferenceselector--loading",
    ].map((id) => [id, "DrillIn state showcase — no antd half in this export"]),
    ...[
        "agenta-entity-ui-drillin-agentconfigskeleton--in-panel",
        "agenta-entity-ui-drillin-agentintegrationdrawer--open-on-integration",
        "agenta-entity-ui-drillin-agenttemplatecontrol--blank",
        ...
        "agenta-entity-ui-drillin-revertgroupbutton--default",
        "agenta-entity-ui-drillin-revertgroupbutton--disabled",
    ].map((id) => [id, "agentTemplate state showcase — no antd half in this export"]),
    // Opened naturally (Radix-managed) rather than force-mounted inline: `AddItemMenu` does
    // not forward `defaultOpen`/`container`, so the panel cannot be portaled into a
    // `data-open-compare` pair. The panel's pixel pair lives on `additemmenu--antd-vs-agenta`.
    ...[
        "agenta-entity-ui-drillin-agentintegrationdrawer--open-state",
        "agenta-entity-ui-drillin-agenttoolselectorpopover--open-state",
    ].map((id) => [id, "natural-open showcase — no inline antd half in this export"]),
    // Renders only the migrated popover with a gateway connection seeded — the file's
    // antd half belongs to its `--antd-vs-agenta` and `--open-state` exports.
    [
        "agenta-entity-ui-drillin-toolselectorpopover--open-state-with-gateway",
        "gateway-seeded showcase — no antd half in this export",
    ],
])
