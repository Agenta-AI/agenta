...
// Tailwind v4's preflight dropped the pointer cursor on <button>, and preflight is off here
// anyway, so the cursor is stated on the control — as @agenta/ui's Button already does.
