...
export const HomeListSkeleton = () => (
    <div className="flex flex-col gap-0.5">
        {[70, 55, 62, 48, 58].map((width, index) => (
            <div key={index} className="flex items-center gap-3.5 px-1.5 py-2">
...
export const HomeSectionEmpty = ({text}: {text: string}) => (
    <p className="text-muted-foreground px-1.5 py-6 text-xs">{text}</p>
)

export const HomeListError = ({onRetry}: {onRetry: () => void}) => (
    <div className="flex flex-col items-start gap-2 px-1.5 py-6">
