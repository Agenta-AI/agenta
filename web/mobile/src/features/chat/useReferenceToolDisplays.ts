...
/** Teach the tool-display registry this agent's own gateway tools, so their rows wear the app's
 * logo. Registered, not passed down: the registry is what every row already resolves through. */
