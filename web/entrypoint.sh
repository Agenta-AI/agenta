...
window.__env = {
  ...
  NEXT_PUBLIC_AGENT_CHAT_SLICE: "${NEXT_PUBLIC_AGENT_CHAT_SLICE}",
  NEXT_PUBLIC_AGENT_CHAT_VIRTUALIZATION: "${NEXT_PUBLIC_AGENT_CHAT_VIRTUALIZATION}",
  NEXT_PUBLIC_AGENT_TEMPLATE_BUILDER: "${NEXT_PUBLIC_AGENT_TEMPLATE_BUILDER}",
  NEXT_PUBLIC_AGENT_TEMPLATE_STRIP: "${NEXT_PUBLIC_AGENT_TEMPLATE_STRIP}",
  NEXT_PUBLIC_AGENT_PLAYGROUND_ONBOARDING: "${NEXT_PUBLIC_AGENT_PLAYGROUND_ONBOARDING}",
  NEXT_PUBLIC_SUPERTOKENS_PASSWORD_POLICY: "${NEXT_PUBLIC_SUPERTOKENS_PASSWORD_POLICY}",
  NEXT_PUBLIC_SUPERTOKENS_PASSWORD_MIN_LENGTH: "${NEXT_PUBLIC_SUPERTOKENS_PASSWORD_MIN_LENGTH}",
  NEXT_PUBLIC_SUPERTOKENS_PASSWORD_MAX_LENGTH: "${NEXT_PUBLIC_SUPERTOKENS_PASSWORD_MAX_LENGTH}",
  NEXT_PUBLIC_ENABLE_ATOM_LOGS: "${NEXT_PUBLIC_ENABLE_ATOM_LOGS}",
  NEXT_PUBLIC_LOG_APP_ATOMS: "${NEXT_PUBLIC_LOG_APP_ATOMS}",
};
EOF
