...
SENDGRID_FROM_EMAIL_VALUE="${SENDGRID_FROM_EMAIL:-${SENDGRID_FROM_ADDRESS:-${AGENTA_AUTHN_EMAIL_FROM:-${AGENTA_SEND_EMAIL_FROM_ADDRESS}}}}"
if [ -n "$SENDGRID_API_KEY" ] && [ -n "$SENDGRID_FROM_EMAIL_VALUE" ]; then
...
window.__env = {
  ...
  NEXT_PUBLIC_AGENTA_EMAIL_DELIVERY_ENABLED: "${AGENTA_EMAIL_DELIVERY_ENABLED}",
