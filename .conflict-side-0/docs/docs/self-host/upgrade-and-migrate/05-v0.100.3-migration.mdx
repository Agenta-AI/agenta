...
slug: /self-host/upgrades/v0.100.3-migration
...
| `email.sendgrid.fromAddress` | `sendgrid.fromEmail` |
...
| `AGENTA_AUTHN_EMAIL_FROM` / `AGENTA_SEND_EMAIL_FROM_ADDRESS` | `SMTP_FROM_EMAIL` (preferred) or `SENDGRID_FROM_EMAIL` fallback |
