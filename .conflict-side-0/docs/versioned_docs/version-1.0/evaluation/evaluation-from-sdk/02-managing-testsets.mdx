...
```bash
curl -X PUT "https://cloud.agenta.ai/api/simple/testsets/{testset_id}" \
  -H "Content-Type: application/json" \
  -H "Authorization: ApiKey YOUR_API_KEY" \
  -d '{
    "testset": {
...
```bash
curl -X POST "https://cloud.agenta.ai/api/simple/testsets/query" \
  -H "Content-Type: application/json" \
  -H "Authorization: ApiKey YOUR_API_KEY" \
  -d '{}'
```
...
```bash
curl -X GET "https://cloud.agenta.ai/api/simple/testsets/{testset_id}" \
  -H "Authorization: ApiKey YOUR_API_KEY"
```
...
```bash
curl -X POST "https://cloud.agenta.ai/api/testsets/revisions/retrieve" \
  -H "Content-Type: application/json" \
  -H "Authorization: ApiKey YOUR_API_KEY" \
  -d '{
