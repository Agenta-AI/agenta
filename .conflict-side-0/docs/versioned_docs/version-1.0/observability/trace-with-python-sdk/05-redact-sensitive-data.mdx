...
- Understand how to [track costs](/1.0/observability/trace-with-python-sdk/track-costs)
- Explore [distributed tracing](/1.0/observability/trace-with-python-sdk/distributed-tracing) across services
- Learn how to [annotate traces](/1.0/observability/trace-with-python-sdk/annotate-traces) programmatically
