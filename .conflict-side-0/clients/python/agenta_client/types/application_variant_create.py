...
class ApplicationVariantCreate(UniversalBaseModel):
...
update_forward_refs(ApplicationVariantCreate, FullJsonInput=FullJsonInput, LabelJsonInput=LabelJsonInput)
