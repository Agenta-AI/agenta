...
- New LLM Provider: Welcome Gemini! We are excited to announce the addition of Google's Gemini to our list of supported LLM providers, bringing the total number to 12.
...
**Improvements**
- To add an LLM App output we used to select the testset, now the testset is selected by default.
...
**Improvements**
- We used to display the average cost in evaluations results table. We think the total cost makes more sense.
