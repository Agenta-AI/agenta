...
Before submitting a pull request (PR), it's crucial to run frontend tests to ensure your changes don't introduce new issues. This section guides you through the process.

1. Open a terminal or command prompt.
2. Start the agenta platform locally by running `docker compose -f "docker-compose.yml" up -d --build`
3. Navigate to the frontend directory of the project `cd agenta-web`
4. Run `npm run test` to run the frontend tests
