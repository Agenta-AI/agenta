...
<Note>You can also directly answer the questions through the command line, ie: `agenta init agenta init --app_name test --backend_host https://agenta.xxx.com/`</Note>
