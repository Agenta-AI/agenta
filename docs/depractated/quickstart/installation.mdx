...
<Note> This guide helps you install Agenta on your local machine. If you're looking to set it up on a server for multiple users, head over to [this guide](/self-host/host-remotely). </Note>
...
<Card title="Well Done!" icon="check" iconType="duotone" color="#29B772" href="/quickstart/getting-started-ui">
