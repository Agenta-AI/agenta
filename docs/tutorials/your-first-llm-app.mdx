...
description: Crafting Your First LLM Application with Agenta Lab
---

In this tutorial, we'll lead you through the process of creating your first Language Learning Model (LLM) application using Agenta Lab. Our aim is to build an application capable of producing a compelling startup pitch based on the startup's name and core idea. By the end of the tutorial, we'll have our app set up locally, ready for iterative refinement in the playground. You'll have the ability to modify parameters, branch out new variants, and systematically assess different versions in Agenta Lab.
...
## 8. Deploying to Agenta Lab
Our app is still local. To make it available in the playground, add it to Agenta Lab by running:
...
Congratulations! You've crafted and deployed your first LLM app with Agenta Lab. You can now experiment and refine it further in the playground. 
