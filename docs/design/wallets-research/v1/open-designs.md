...
Items 2, 4, 7, 14, 20, and 21 are decided. The table is an index only; each numbered item below contains the
...
delivery, stable across its retries and distinct for two genuinely different changes, and the
