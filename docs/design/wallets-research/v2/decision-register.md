...
| 15 | Open | Missed grants during flag-off period | hardening; funding | Choose eligible organizations and amount before an idempotent backfill; no automatic retroactive grant assumed. |
