...
- **SDK design phase can start now.** 13 pain entries + 5 cross-cutting takeaways + 3 SDK requirements is enough material to sketch the SDK API surface with confidence.
