...
- [x] Add **runner integration tests** that run both harness configurations against the mock MCP
      service and assert `tools/list` plus the `echo` marker result.
- [x] Add parameterized **OSS and EE acceptance tests** for builtin, standard, and custom MCP
