...
else in `v2/` assumes these and states only what is.

Carries forward `v1/decisions.md`. Where a v2 document elaborates a decision, that document
...
Tracked in [`../v1/open-designs.md`](../v1/open-designs.md) until they settle here. The ones
