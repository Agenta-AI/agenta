# One-shot config editing — 2026-08-06T22:36:49Z
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| pi-haiku-local | 2/3 | 0/3 | 0/3 | 0/3 | 0/3 | 0/3 | 0/3 | 10% | 14% | 14% | $0.11 |
| claude-haiku-local | 0/3 | 1/3 | 3/3 | 2/3 | 0/3 | 1/3 | 0/3 | 33% | 67% | 86% | $0.79 |
| pi-luna-local | 3/3 | 2/3 | 3/3 | 3/3 | 0/3 | 1/3 | 0/3 | 57% | 67% | 86% | $0.26 |
| codex-luna-local | 3/3 | 3/3 | 2/3 | 3/3 | 0/3 | 1/3 | 0/3 | 57% | 71% | 86% | $0.00 |
...
|---|---|---|---|---|---|
| read-02-list-skills | read | 67% | 100% | +33% |  |
| skill-01-add-inline | skills | 50% | 75% | +25% | stored_len |
| skill-02-edit-body | skills | 67% | 75% | +8% | stored_not_contains |
| skill-03-remove | skills | 67% | 75% | +8% | stored_len |
| skill-04-rename | skills | 0% | 75% | +75% | item_rename_not_allowed |
| list-03-nested-file-entry | list_entries | 25% | 75% | +50% | stored_matches |
...
|---|---|---|---|---|---|---|
| pi-haiku-local | 0 | 10 | 2 | 2 | 0 | 4 |
| claude-haiku-local | 0 | 3 | 0 | 0 | 0 | 0 |
| pi-luna-local | 0 | 3 | 0 | 0 | 0 | 0 |
| codex-luna-local | 0 | 2 | 1 | 0 | 0 | 0 |

| scenario | shape | trials |
|---|---|---|
| fm-01-invented-marker | no_action | 8 |
| fm-01-invented-marker | unsettled | 3 |
| skill-01-add-inline | no_action | 2 |
| skill-02-edit-body | no_action | 2 |
| skill-03-remove | no_action | 2 |
| skill-04-rename | no_action | 2 |
| list-03-nested-file-entry | no_action | 2 |
| skill-01-add-inline | unsettled | 1 |
| skill-02-edit-body | wrong_surface | 1 |
| skill-03-remove | attempt_refused | 1 |
| skill-04-rename | attempt_refused | 1 |
| list-03-nested-file-entry | wrong_surface | 1 |
