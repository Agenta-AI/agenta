---
title: Using your code in Agenta
description: 'Create and deploy your first LLM app in under 4 minutes'
---

<Note>This tutorial is for users who want to create LLM apps based on templates from the UI. If you want to use your own code in agenta, you can jump directlly to  </Note>
## Introduction
