...
/**
 * Hamburger as two short bars with a "Menu" label, instead of the theme's
 * three-line 30px glyph. The bars are plain spans so navbar.css can size and
 * colour them with the rest of the header.
 */
