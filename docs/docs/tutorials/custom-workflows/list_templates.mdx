...
### [Single Prompt Application using OpenAI and Langchain](/tutorials/custom-workflows/first-app-with-langchain)
...
### [Use Mistral from Huggingface for a Summarization Task](/tutorials/custom-workflows/deploy-mistral-model)

Learn how to use a custom model with agenta.

## Retrieval Augmented Generation (RAG)

### [RAG Application with LlamaIndex](/tutorials/custom-workflows/build-rag-application)
...
### [Extraction using OpenAI Functions and Langchain](/tutorials/custom-workflows/extract_job_information)
