...
The complete code for this tutorial is in the [RAG QA Chatbot example](https://github.com/Agenta-AI/agenta/tree/main/agenta/examples/python/RAG_QA_chatbot). The evaluation script is at [`scripts/evaluate_rag.py`](https://github.com/Agenta-AI/agenta/blob/main/agenta/examples/python/RAG_QA_chatbot/scripts/evaluate_rag.py). See the [README](https://github.com/Agenta-AI/agenta/blob/main/agenta/examples/python/RAG_QA_chatbot/README.md) for setup instructions.

```bash
# Clone, install, and run the evaluation
git clone https://github.com/Agenta-AI/agenta.git
cd agenta/agenta/examples/python/RAG_QA_chatbot
