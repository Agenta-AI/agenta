...
- placeholder: create automation dialog for the webhook form
...
<iframe
  src="https://www.val.town/x/mmabrouk/webhook-env-agenta"
  title="Val Town webhook example"
  style={{width: "100%", height: "640px", border: "1px solid #e5e7eb", borderRadius: "12px"}}
/>
