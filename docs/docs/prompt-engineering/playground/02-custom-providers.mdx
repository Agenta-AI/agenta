...
## Configuring Vertex AI {#configuring-vertex-ai}
...
## Configuring OpenAI-Compatible Endpoints (e.g., Ollama) {#configuring-openai-compatible-endpoints-eg-ollama}
...
## Adding Models to a Provider (e.g. OpenRouter) {#adding-models-to-a-provider-eg-openrouter}
