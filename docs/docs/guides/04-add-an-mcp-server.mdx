...
:::info Planned MCP connection flow
The gateway work in PR #6049 targets a single Connect flow: enter the MCP URL, confirm an editable suggested name, complete OAuth when supported, then open the connection to inspect tools and change their permissions. This flow is not yet release-ready. The instructions below describe the earlier flow and will be updated with verified steps before the MCP release.
:::
