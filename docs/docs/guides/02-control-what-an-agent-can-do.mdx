...
<Image
  ...
  img={require("/images/agents/agenta-tool-permission-wide.png")}
...
2. The harness allow list, which is where `Always allow` puts a built-in.
...
<Image
  ...
  alt="An approval card in the conversation, with the Payload expander, the Deny and Approve buttons, and the always-allow toggle"
  loading="lazy"
/>
