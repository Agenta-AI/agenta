...
<span style={{ backgroundColor: "#FEF0F0", color: "#DC2626" }}>
  {" "}
  Text Generation{" "}
</span> <span>&nbsp;</span> <span
  style={{ backgroundColor: "#FEF0F0", color: "#DC2626" }}
>
  {" "}
  OpenAI{" "}
</span> <span>&nbsp;</span> <span
...
<span style={{ backgroundColor: "#FEF0F0", color: "#DC2626" }}> Sales </span> <span>
  &nbsp;
</span> <span style={{ backgroundColor: "#FEF0F0", color: "#DC2626" }}>
  {" "}
  OpenAI{" "}
</span> <span>&nbsp;</span> <span
  style={{ backgroundColor: "#FEF0F0", color: "#DC2626" }}
