...
This endpoint accepts a detailed specification of the entire account graph including organizations, workspaces, projects, memberships, and API keys. See the [API reference](/reference/api/admin-create-accounts) for the full request schema.
...
- [Create Accounts](/reference/api/admin-create-accounts) &mdash; batch account creation
