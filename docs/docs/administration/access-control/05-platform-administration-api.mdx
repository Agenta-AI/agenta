...
This endpoint accepts a detailed specification of the entire account graph including organizations, workspaces, projects, memberships, and API keys. See the [API reference](/reference/api/create-accounts-admin-accounts-post) for the full request schema.
...
- [Create Account](/reference/api/create-simple-accounts-admin-simple-accounts-post) &mdash; single account creation
- [Create Accounts](/reference/api/create-accounts-admin-accounts-post) &mdash; batch account creation
