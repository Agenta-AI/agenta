...
<Image img={require("/images/prompt_management/llm_lifecycle.png")} className="block mx-auto w-[75%]" />
...
<Image img={require("/images/prompt_management/taxonomy_agenta.png")} className="block mx-auto w-[75%]" />
