...
<Heading as={"h1"} className={"openapi__heading"} children={"Archive Testset"}></Heading>

<MethodEndpoint method={"post"} path={"/preview/testsets/{testset_id}/archive"}></MethodEndpoint>
