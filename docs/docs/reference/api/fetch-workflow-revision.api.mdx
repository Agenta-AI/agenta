...
<Heading as={"h1"} className={"openapi__heading"} children={"Fetch Workflow Revision"}></Heading>

<MethodEndpoint method={"get"} path={"/preview/base/workflows/revisions/{revision_id}"}></MethodEndpoint>
