...
<div style={{ marginBottom: "2rem" }}>
  ...
  <SchemaTabs className={"openapi-tabs__security-schemes"}>
    <TabItem label={"API Key: APIKeyHeader"} value={"APIKeyHeader"}>
      <div>
        <table>
          <tbody>
            <tr>
...
>
  ...
  <span>Agenta: [team@agenta.ai](mailto:team@agenta.ai)</span>
  <span>URL: [https://agenta.ai](mailto:https://agenta.ai)</span>
</div>
