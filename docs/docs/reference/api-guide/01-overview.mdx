...
This guide documents the conventions used across the Agenta REST API. The [API Reference](/reference/api/) describes every endpoint individually. This guide explains the patterns that apply across endpoints so the reference pages are easier to read.
