...
#### Redis (Task Queue, Caching & Sessions) {#redis-caching}
...
| `SUPERTOKENS_EMAIL_DISABLED` | Disable email-based authentication (password and OTP). Use when only OAuth/SSO is desired. | `false` |
