...
The chart defaults to `ingress.className: "traefik"`. If your cluster uses a different ingress controller, override this value to match. For example, with the NGINX Ingress Controller:
...
**NGINX Ingress Controller**: Use rewrite annotations:
