...
export AGENTA_RUNNER_IMAGE="ghcr.io/agenta-ai/agenta-agent-runner:latest"
```
...
export AGENTA_RUNNER_IMAGE="ghcr.io/agenta-ai/agenta-agent-runner:v0.30.0"
```
...
| Variable | Default | Description |
|---|---|---|
| `AGENTA_RUNNER_IMAGE` | `ghcr.io/agenta-ai/agenta-agent-runner:latest` | Image used by the `sandbox-agent` runner service |
