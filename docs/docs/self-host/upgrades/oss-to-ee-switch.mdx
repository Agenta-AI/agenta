---
title: Switch a Self-Hosted Deployment from OSS to EE
sidebar_label: OSS → EE
description: 'How to switch an existing self-hosted Agenta OSS deployment to EE in place, keeping all your data: stop the stack, point EE at your existing databases, and start it again. The EE migration creates the extra tables and backfills the EE-only data on first run.'
---
