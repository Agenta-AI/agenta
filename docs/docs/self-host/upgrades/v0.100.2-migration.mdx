...
| `secrets.oauth.GOOGLE_OAUTH_CLIENT_ID` | `identity.google.clientId` |
| `secrets.oauth.GITHUB_OAUTH_CLIENT_ID` | `identity.github.clientId` |
| `secrets.llmProviders.OPENAI_API_KEY` | `llm.openai` |
| `secrets.llmProviders.ANTHROPIC_API_KEY` | `llm.anthropic` |
