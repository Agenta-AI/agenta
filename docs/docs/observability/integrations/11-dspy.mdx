---
title: Observability for DSPy with Agenta
sidebar_label: DSPy
...
:::info
This tutorial is also available as a [Jupyter notebook](https://github.com/Agenta-AI/agenta/tree/main/examples/jupyter/integrations/dspy-integration.ipynb) for interactive learning and experimentation.
:::
