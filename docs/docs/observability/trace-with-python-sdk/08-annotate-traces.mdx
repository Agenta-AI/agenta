...
response = requests.post(
    f"{base_url}/api/annotations/query",
    headers=headers,
    json=query_data
)
...
async function queryAnnotation() {
  ...
  try {
    const response = await fetch(`${baseUrl}/api/annotations/query`, {
      method: 'POST',
      headers: headers,
...
response = requests.delete(
    f"{base_url}/api/annotations/{trace_id}/{span_id}",
    headers=headers
)
...
async function deleteAnnotation() {
  ...
  try {
    const response = await fetch(`${baseUrl}/api/annotations/${traceId}/${spanId}`, {
      method: 'DELETE',
      headers: headers
    });
