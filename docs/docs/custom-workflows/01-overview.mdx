...
<img
  src="/images/custom-workflows/custom-workflows-draft.png"
  alt="Custom Workflows Overview"
  width="100%"
/>

LLM applications are more than single prompts —they involve orchestrating models,
configurations, and processes to ensure consistent results
