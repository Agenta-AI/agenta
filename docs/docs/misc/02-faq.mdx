...
You can add any OpenAI compatible endpoint, including self-hosted models and custom models (for instance using [Ollama](https://agenta.ai/docs/prompt-engineering/playground/custom-providers#configuring-openai-compatible-endpoints-eg-ollama)).
