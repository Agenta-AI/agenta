...
Set up Agenta on your machine before you start coding. Follow the [local installation guide](/self-host/quick-start), then use the [development mode guide](/misc/contributing/guides/development-mode) to run the project for local work.
...
- [Testing](/misc/contributing/guides/testing)
- [Formatting and Linting](/misc/contributing/guides/formatting-and-linting)
