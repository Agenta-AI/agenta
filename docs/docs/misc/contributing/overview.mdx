...
If you want to open your first pull request, read [Creating Your First PR](/misc/contributing/first-pr). It walks through the full path from picking an issue to opening the PR.

If you want to report a problem or propose an idea, read [Filing an Issue](/misc/contributing/guides/file-issue).

If you want to work on deployment and hosting surfaces, read [Community Projects](/misc/contributing/guides/community-projects).
