...
1. **Network Logs in the Browser:**
   ...
   <Image img={require("/images/creating-issue/inspect-network-1.png")} />

   - Navigate to the "Network" tab.
   <Image img={require("/images/creating-issue/inspect-network-2.png")} />
   ...
   <Image img={require("/images/creating-issue/inspect-network-3.png")} />
   ...
   <Image img={require("/images/creating-issue/inspect-network-4.png")} />
   <Image img={require("/images/creating-issue/inspect-network-5.png")} />
...
2. **Docker Containers Information:**
   ...
   <Image img={require("/images/creating-issue/docker-log-1.png")} />
   <Image img={require("/images/creating-issue/docker-log-terminal.png")} />
   ...
   - If your issue is associated with a specific llm app;
     ...
     - On Docker Desktop, open the container of that llm app and provide a screenshot of it.
       ...
       <Image img={require("/images/creating-issue/docker-log-llm-app.png")} />
   ...
   {" "}
   <Image img={require("/images/creating-issue/docker-log-terminal-llm-app.png")} />
   ...
   - For the agenta-backend container, provide the logs;
     ...
     - by opening the container in Docker Desktop and providing a screenshot of it.
       <Image img={require("/images/creating-issue/docker-log-agenta-backend.png")} />
