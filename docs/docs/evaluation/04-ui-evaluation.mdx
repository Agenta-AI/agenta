...
<img
  className="dark:hidden"
  src="/images/basic_guides/16_new_evaluator_modal_light.png"
/>
<img
  className="hidden dark:block"
  src="/images/basic_guides/16_new_evaluator_modal_dark.png"
/>
...
<img
  className="dark:hidden"
  src="/images/basic_guides/17_begin_evaluation_modal_light.png"
/>
<img
  className="hidden dark:block"
  src="/images/basic_guides/17_begin_evaluation_modal_dark.png"
/>
...
- **Max Retries:** Specify the maximum number of retries for a failed languagemodel call **(default is 3)**.
...
- <b>Correct Answer Column:</b> Specify the column in the test set containing the
  correct/expected answer <b>(default is correct_answer)</b>.

<img
  className="dark:hidden"
  src="/images/basic_guides/18_begin_evaluation_modal_advanced_config_light.png"
/>
<img
  className="hidden dark:block"
  src="/images/basic_guides/18_begin_evaluation_modal_advanced_config_dark.png"
/>
...
<img
  className="dark:hidden"
  src="/images/basic_guides/19_view_evaluation_result_light.png"
/>
<img
  className="hidden dark:block"
  src="/images/basic_guides/19_view_evaluation_result_dark.png"
/>
...
<img
  className="dark:hidden"
  src="/images/basic_guides/20_evaluation_comparison_view_light.png"
/>
<img
  className="hidden dark:block"
  src="/images/basic_guides/20_evaluation_comparison_view_dark.png"
/>
