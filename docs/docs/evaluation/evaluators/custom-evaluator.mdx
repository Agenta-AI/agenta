...
2. <b>Evaluator Template: </b> Choose a template for your custom evaluator. This
   could be based on the specific criteria or type of evaluation you want.
   <img
     className="dark:hidden"
   ...
   creation of your custom evaluator.
...
1. <b>app_params: </b> A dictionary containing the configuration of the app. This
