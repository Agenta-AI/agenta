...
{/* VIDEO: an agent answering a question, then the same agent answering again after its harness and model have been changed, with nothing else about the agent touched */}
...
1. It sends the conversation to the model, together with your [instructions](/concepts/agents), the list of [tools](/concepts/tools-and-integrations) the agent has, and the name and description of each [skill](/concepts/skills).
...
- [Cost and usage](/concepts/cost-and-usage) explains what each pass through the loop costs.
