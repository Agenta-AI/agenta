---
title: "Automations"
sidebar_label: "Automations (Codex)"
description: "An automation starts an agent on a schedule or when an app event happens, without someone opening a chat first."
---
...
That destination might be a channel, an email, a document, a task, or a row in a sheet. Give the agent the appropriate [tool](/concepts/tools-and-integrations), name the destination in the trigger message, and decide what should happen if delivery fails.
...
- [Build a marketing coworker](/learn/build-a-marketing-coworker)
