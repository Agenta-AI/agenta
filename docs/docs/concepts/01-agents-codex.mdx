...
[Build your first agent](/learn/build-your-first-agent) walks through the conversation-based path.
...
See [Sessions and versions](/concepts/sessions-and-versions) for the full distinction.
