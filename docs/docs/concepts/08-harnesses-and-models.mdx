...
All three also accept the [MCP servers](/guides/add-an-mcp-server) you connect to a project, so the tools an agent gets from a server do not change when you switch harness.
