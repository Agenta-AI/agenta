...
<Image
  ...
  alt="The AGENTS.md editor dialog with its toolbar and the writing tips rail"
  loading="lazy"
/>
...
<Image
  style={{ display: "block", margin: "24px 0" }}
  img={require("/images/agents/schedules-new-schedule.png")}
  alt="The New schedule dialog with its cadence list, day and time pickers, version selector, and message box"
  loading="lazy"
/>
