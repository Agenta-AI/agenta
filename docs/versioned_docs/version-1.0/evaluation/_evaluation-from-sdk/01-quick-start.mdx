...
- Learn about [setup and configuration](/1.0/evaluation/evaluation-from-sdk/setup-configuration)
- Explore [managing test sets with the SDK](/1.0/evaluation/evaluation-from-sdk/managing-test-sets)
- Understand [configuring evaluators](/1.0/evaluation/evaluation-from-sdk/configuring-evaluators)
- See how to [run evaluations](/1.0/evaluation/evaluation-from-sdk/running-evaluations) in detail
