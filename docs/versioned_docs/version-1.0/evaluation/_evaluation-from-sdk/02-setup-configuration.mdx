...
- Learn about [managing test sets](/1.0/evaluation/evaluation-from-sdk/managing-test-sets)
- Explore [configuring evaluators](/1.0/evaluation/evaluation-from-sdk/configuring-evaluators)
- Start [running evaluations](/1.0/evaluation/evaluation-from-sdk/running-evaluations)
