...
In production, you fetch the configuration from Agenta and run independently. Agenta is not in your request path. See [Integration](/1.0/custom-workflows/integration) for details.
