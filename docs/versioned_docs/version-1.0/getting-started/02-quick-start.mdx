...
## Step 1: Create Your First Prompt {#step-1-create-your-first-prompt}
...
## Step 3: Create a Test Set {#step-3-create-a-test-set}
...
## Step 4: Evaluate Your Prompt {#step-4-evaluate-your-prompt}
...
:::info
Agenta comes with a [set of built-in evaluators](/1.0/evaluation/concepts) that you can use to evaluate your prompt. You can also create your own custom evaluator [using code](/1.0/evaluation/configure-evaluators/custom-evaluator) or [webhooks](/1.0/evaluation/configure-evaluators/webhook-evaluator).
:::
...
## Step 6: Integrate with Your App: Fetch the Prompt Configuration {#step-6-integrate-with-your-app-fetch-the-prompt-configuration}
...
const fetchConfigs = async () => {
  const url = 'https://cloud.agenta.ai/api/applications/revisions/retrieve';
...
- [Set up your evaluation workflow](/1.0/evaluation/concepts)
- [Set up observability](/1.0/observability/overview) and explore the different integrations
- [Set up custom workflows](/1.0/custom-workflows/overview) to enable product teams to run evaluations on complex applications from the UI
