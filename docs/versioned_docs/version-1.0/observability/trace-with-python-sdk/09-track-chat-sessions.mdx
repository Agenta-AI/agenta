...
:::info
This guide covers tracking chat sessions with the Agenta Python SDK. For JavaScript/TypeScript or other OpenTelemetry-based clients, see the [session tracking with OpenTelemetry guide](/1.0/observability/trace-with-opentelemetry/session-tracking).
:::
