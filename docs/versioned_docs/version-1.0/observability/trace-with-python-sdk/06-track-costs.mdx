...
When you use auto-instrumentation from [compatible libraries](/1.0/observability/concepts#auto-instrumentation-compatibility), prompts and tokens are automatically extracted and formatted. Costs are calculated when possible.
...
Learn about [adding metadata](/1.0/observability/trace-with-python-sdk/adding-metadata) to enrich your traces.
