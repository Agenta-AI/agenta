...
See the [semantic conventions guide](/1.0/observability/trace-with-opentelemetry/semantic-conventions) for more details on how attributes are organized.
...
- Explore [distributed tracing](/1.0/observability/trace-with-python-sdk/distributed-tracing) across services
