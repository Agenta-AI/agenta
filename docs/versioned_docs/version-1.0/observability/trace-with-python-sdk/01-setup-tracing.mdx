...
- Easy function instrumentation using [decorators](/1.0/observability/trace-with-python-sdk/instrument-functions)
- [Reference prompt versions](/1.0/observability/trace-with-python-sdk/reference-prompt-versions) to link traces to applications, variants, and environments
- [Add attributes](/1.0/observability/trace-with-python-sdk/adding-metadata) to spans for additional metadata
...
- Learn how to [instrument your functions](/1.0/observability/trace-with-python-sdk/instrument-functions)
- Link traces to [prompt versions](/1.0/observability/trace-with-python-sdk/reference-prompt-versions)
- Understand how to [redact sensitive data](/1.0/observability/trace-with-python-sdk/redact-sensitive-data)
