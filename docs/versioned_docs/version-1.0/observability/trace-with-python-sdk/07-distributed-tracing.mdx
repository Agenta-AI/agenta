...
- Learn about [tracing without the Agenta SDK](/1.0/observability/trace-with-opentelemetry/distributed-tracing) for raw OpenTelemetry setup
- Explore [semantic conventions](/1.0/observability/trace-with-opentelemetry/semantic-conventions) for better trace formatting
- See [instrumenting functions](/1.0/observability/trace-with-python-sdk/instrument-functions) for automatic instrumentation
