...
Check the [Agenta documentation](/1.0/observability/concepts) for more details about observability concepts. Review our [integration guides](/1.0/integrations/llm-providers/openai/observability) for framework-specific help. Visit our [GitHub issues](https://github.com/anthropics/agenta/issues) to report bugs. Join our community for support.

## Next steps

Review the [setup instructions](/1.0/observability/trace-with-python-sdk/setup-tracing) to ensure correct configuration. Explore [distributed tracing](/1.0/observability/trace-with-opentelemetry/distributed-tracing) to understand how traces work across services. Check the [integrations](/1.0/integrations/llm-providers/openai/observability) page for your specific framework.
