...
See all available attributes in our [semantic conventions guide](/1.0/observability/trace-with-opentelemetry/semantic-conventions).
...
Learn more about using references in the [reference prompt versions guide](/1.0/observability/trace-with-python-sdk/reference-prompt-versions).
...
- [Get started with Python SDK](/1.0/observability/quickstart-python)
- [Learn about tracing with OpenTelemetry](/1.0/observability/trace-with-opentelemetry/getting-started)
- [Explore integrations](/1.0/integrations/llm-providers/openai/observability) for popular LLM frameworks
