...
- Learn about [semantic conventions](/1.0/observability/trace-with-opentelemetry/semantic-conventions)
- Explore [collector configuration](/1.0/observability/trace-with-opentelemetry/otel-collector-configuration)
- See [Python SDK distributed tracing](/1.0/observability/trace-with-python-sdk/distributed-tracing) for Agenta SDK approach
