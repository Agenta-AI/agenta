...
- Learn about [semantic conventions](/1.0/observability/trace-with-opentelemetry/semantic-conventions) for proper trace formatting
- Explore [distributed tracing](/1.0/observability/trace-with-opentelemetry/distributed-tracing) without the Agenta SDK
