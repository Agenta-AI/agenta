...
<article key='1' className="col col--6 margin-bottom--lg">
  ...
  <CustomDocCard
    item={{
      type: "link",
      href: "/1.0/observability/quickstart-python",
  ...
  <CustomDocCard
    item={{
      type: "link",
      href: "/1.0/observability/quick-start-opentelemetry",
...
<article key="1" className="col col--6 margin-bottom--lg">
  <CustomDocCard
    item={{
      type: "link",
      href: "/1.0/integrations/llm-providers/openai/observability",
      label: "OpenAI",
      description:
  ...
  <CustomDocCard
    item={{
      type: "link",
      href: "/1.0/integrations/llm-providers/litellm/observability",
      label: "LiteLLM",
...
<article key="1" className="col col--6 margin-bottom--lg">
  <CustomDocCard
    item={{
      type: "link",
      href: "/1.0/integrations/frameworks/langchain/observability",
      label: "LangChain",
      description:
  ...
  <CustomDocCard
    item={{
      type: "link",
      href: "/1.0/integrations/libraries/instructor/observability",
      label: "Instructor",
...
<article key="1" className="col col--6 margin-bottom--lg">
  <CustomDocCard
    item={{
      type: "link",
      href: "/1.0/integrations/frameworks/llamaindex/observability",
      label: "LlamaIndex",
  ...
  <CustomDocCard
    item={{
      type: "link",
      href: "/1.0/integrations/frameworks/langgraph/observability",
      label: "LangGraph",
...
<article key="1" className="col col--6 margin-bottom--lg">
  <CustomDocCard
    item={{
      type: "link",
      href: "/1.0/integrations/frameworks/openai-agents/observability",
      label: "OpenAI Agents",
  ...
  <CustomDocCard
    item={{
      type: "link",
      href: "/1.0/integrations/frameworks/pydanticai/observability",
      label: "PydanticAI",
...
<article key="1" className="col col--6 margin-bottom--lg">
  <CustomDocCard
    item={{
      type: "link",
      href: "/1.0/integrations/frameworks/dspy/observability",
      label: "DSPy",
  ...
  <CustomDocCard
    item={{
      type: "link",
      href: "/1.0/integrations/frameworks/agno/observability",
      label: "Agno",
