...
- Learn about [Query API](/1.0/observability/query-data/query-api) for detailed trace data
- Explore [Using the UI](/1.0/observability/concepts) for visual analytics
- Read about [Semantic Conventions](/1.0/observability/trace-with-opentelemetry/semantic-conventions) for available metrics
