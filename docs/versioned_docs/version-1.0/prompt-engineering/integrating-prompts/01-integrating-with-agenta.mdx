...
### [1. As a prompt management system](/1.0/prompt-engineering/integrating-prompts/fetch-prompt-programatically)
...
- You need to set up [observability integration](/1.0/observability/quickstart-python) yourself. This is required if you want to trace your calls for debugging and cost tracking.
...
### [2. As a middleware/gateway (invoking prompt)](/1.0/prompt-engineering/integrating-prompts/proxy-calls)
