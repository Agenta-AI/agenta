...
:::tip
Check the [reference](/1.0/reference/sdk/configuration-management#prompt-configuration-schema) section for more details on the data format used for prompts.
:::
...
const fetchResponse = await fetch('https://cloud.agenta.ai/api/applications/revisions/retrieve', {
  method: 'POST',
  headers: {
