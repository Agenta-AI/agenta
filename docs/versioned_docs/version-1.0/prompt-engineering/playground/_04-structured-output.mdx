...
This section is under construction. For basic information on dynamic JSON schema variables, see the [Using the Playground guide](/1.0/prompt-engineering/playground/using-playground#dynamic-json-schema-variables).
