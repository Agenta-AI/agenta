...
Python SDK: This is a library necessary for implementing Agenta in your Python apps.
Command Line Interface (CLI): A tool for serving and deploying your apps with Agenta.
Backend: Handles tasks like deployment, app management, and data management.
Frontend: A web interface to assess, test, and monitor your apps.
