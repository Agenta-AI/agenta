...
To enable navigation links, store references in your traces using the Python SDK (`ag.tracing.store_refs()`) or OpenTelemetry span attributes. See the [reference prompt versions guide](/1.0/observability/trace-with-python-sdk/reference-prompt-versions) for details.
...
- [Reference Prompt Versions (Python SDK)](/1.0/observability/trace-with-python-sdk/reference-prompt-versions)
- [Semantic Conventions (OpenTelemetry)](/1.0/observability/trace-with-opentelemetry/semantic-conventions)
