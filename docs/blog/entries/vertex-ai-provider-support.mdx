...
Check out the documentation for [configuring Vertex AI models](/1.0/prompt-engineering/playground/custom-providers#configuring-vertex-ai).
...
For detailed setup instructions, see our [documentation on adding custom providers](/1.0/prompt-engineering/playground/custom-providers#configuring-vertex-ai).
