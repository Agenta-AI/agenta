...
## Invoking a deployed prompt {#invoking-a-deployed-prompt}
...
## Fetching a prompt configuration {#fetching-a-prompt-configuration}
...
## All affected endpoints {#all-affected-endpoints}
...
| Ingest spans in bulk | `POST /preview/spans/ingest` | OTLP ingestion endpoint (see [Observability docs](/1.0/observability/overview)) |
