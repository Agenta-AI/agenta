...
### [Tool Integrations in the Playground](/changelog/tool-integrations)
...
- You can now use [an external Redis instance](/self-host/configuration#redis) for caching by setting it as an environment variable
