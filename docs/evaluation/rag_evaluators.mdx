...
Sometimes, evaluators that rely on inputs and ouputs may not be sufficient for your specific use case and you may wish to access internal variables, like in the case of RAG. In this page, we will see how to use internal variables and how to configure RAG evaluators on Agenta based on the application tree.
