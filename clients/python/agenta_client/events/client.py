...
class EventsClient:
    ...
    def query_events_rpc(
        ...
        *,
        ...
        """
        _response = self._raw_client.query_events_rpc(
            event=event, windowing=windowing, request_options=request_options
        )
...
class AsyncEventsClient:
    ...
    async def query_events_rpc(
        ...
        *,
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.query_events_rpc(
            event=event, windowing=windowing, request_options=request_options
        )
        return _response.data
