...
if typing.TYPE_CHECKING:
    ...
    from .create_testset_revision_from_file_request_file_type import (
...
_dynamic_imports: typing.Dict[str, str] = {
    ...
    "CreateTestsetRevisionFromFileRequestFileType": ".create_testset_revision_from_file_request_file_type",
