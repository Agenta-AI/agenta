...
class RawAccessClient:
    ...
    def check_organization_access(self, *, organization_id: str, request_options: typing.Optional[RequestOptions] = None) -> HttpResponse[typing.Any]:
        """
    ...
    def update_session_identities(self, *, session_identities: typing.Sequence[str], request_options: typing.Optional[RequestOptions] = None) -> HttpResponse[typing.Any]:
        """
        Parameters
        ----------
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            "auth/session/identities",method="PATCH",
            json={
    ...
    def sso_callback_redirect(self, organization_slug: str, provider_slug: str, *, request_options: typing.Optional[RequestOptions] = None) -> HttpResponse[typing.Any]:
        """
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"auth/sso/callback/{jsonable_encoder(organization_slug)}/{jsonable_encoder(provider_slug)}",method="GET",
            request_options=request_options,)
        try:
            if _response is None or not _response.text.strip():
                return HttpResponse(response=_response, data=None)
...
class AsyncRawAccessClient:
    ...
    async def check_organization_access(self, *, organization_id: str, request_options: typing.Optional[RequestOptions] = None) -> AsyncHttpResponse[typing.Any]:
        """
        Check if the current session satisfies the organization's auth policy.
    ...
    async def update_session_identities(self, *, session_identities: typing.Sequence[str], request_options: typing.Optional[RequestOptions] = None) -> AsyncHttpResponse[typing.Any]:
        """
        Parameters
        ----------
        session_identities : typing.Sequence[str]
    ...
    async def sso_callback_redirect(self, organization_slug: str, provider_slug: str, *, request_options: typing.Optional[RequestOptions] = None) -> AsyncHttpResponse[typing.Any]:
        """
        Custom SSO callback endpoint that redirects to SuperTokens.
