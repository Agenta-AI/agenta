...
class AccessClient:
    ...
    def discover_access(self, *, email: str, request_options: typing.Optional[RequestOptions] = None) -> DiscoverResponse:
        ...
        client.access.discover_access(
            email="email",
        )
        """
        _response = self._raw_client.discover_access(email=email, request_options=request_options)
        return _response.data
    
    def check_organization_access(self, *, organization_id: str, request_options: typing.Optional[RequestOptions] = None) -> typing.Any:
        """
        ...
        client.access.check_organization_access(
            organization_id="organization_id",
        )
        """
        _response = self._raw_client.check_organization_access(organization_id=organization_id, request_options=request_options)
        return _response.data
    
    def update_session_identities(self, *, session_identities: typing.Sequence[str], request_options: typing.Optional[RequestOptions] = None) -> typing.Any:
        """
        Parameters
        ----------
        ...
        client.access.update_session_identities(
            session_identities=["session_identities"],
        )
        """
        _response = self._raw_client.update_session_identities(session_identities=session_identities, request_options=request_options)
        return _response.data
    
    def sso_callback_redirect(self, organization_slug: str, provider_slug: str, *, request_options: typing.Optional[RequestOptions] = None) -> typing.Any:
        """
        ...
        client.access.sso_callback_redirect(
...
class AsyncAccessClient:
    ...
    async def discover_access(self, *, email: str, request_options: typing.Optional[RequestOptions] = None) -> DiscoverResponse:
        ...
        async def main() -> None:
            await client.access.discover_access(
                email="email",
            )
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.discover_access(email=email, request_options=request_options)
        return _response.data
    
    async def check_organization_access(self, *, organization_id: str, request_options: typing.Optional[RequestOptions] = None) -> typing.Any:
        """
        Check if the current session satisfies the organization's auth policy.
        ...
        async def main() -> None:
            await client.access.check_organization_access(
                organization_id="organization_id",
            )
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.check_organization_access(organization_id=organization_id, request_options=request_options)
        return _response.data
    
    async def update_session_identities(self, *, session_identities: typing.Sequence[str], request_options: typing.Optional[RequestOptions] = None) -> typing.Any:
        """
        Parameters
        ----------
        session_identities : typing.Sequence[str]
        ...
        async def main() -> None:
            await client.access.update_session_identities(
                session_identities=["session_identities"],
            )
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.update_session_identities(session_identities=session_identities, request_options=request_options)
        return _response.data
    
    async def sso_callback_redirect(self, organization_slug: str, provider_slug: str, *, request_options: typing.Optional[RequestOptions] = None) -> typing.Any:
        """
        Custom SSO callback endpoint that redirects to SuperTokens.
        ...
        async def main() -> None:
            await client.access.sso_callback_redirect(
                organization_slug="organization_slug",
                provider_slug="provider_slug",
            )
