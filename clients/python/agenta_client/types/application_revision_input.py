...
class ApplicationRevisionInput(UniversalBaseModel):
...
update_forward_refs(ApplicationRevisionInput, FullJsonInput=FullJsonInput, LabelJsonInput=LabelJsonInput)
