...
class ApplicationRevisionOutput(UniversalBaseModel):
    ...
    flags: typing.Optional[ApplicationRevisionFlags] = None
    ...
    data: typing.Optional[ApplicationRevisionDataOutput] = None
...
update_forward_refs(ApplicationRevisionOutput, FullJsonOutput=FullJsonOutput, LabelJsonOutput=LabelJsonOutput)
