...
class EvaluatorQuery(UniversalBaseModel):
    folder_id: typing.Optional[str] = None
    flags: typing.Optional[EvaluatorArtifactQueryFlags] = None
...
update_forward_refs(EvaluatorQuery, FullJsonInput=FullJsonInput, LabelJsonInput=LabelJsonInput)
