...
class SimpleWorkflowQuery(UniversalBaseModel):
    flags: typing.Optional[SimpleWorkflowQueryFlags] = None
...
update_forward_refs(SimpleWorkflowQuery, FullJsonInput=FullJsonInput, LabelJsonInput=LabelJsonInput)
