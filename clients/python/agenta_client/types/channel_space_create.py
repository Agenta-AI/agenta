...
class ChannelSpaceCreate(UniversalBaseModel):
    flags: typing.Optional[ChannelSpaceFlags] = None
...
update_forward_refs(ChannelSpaceCreate, FullJsonInput=FullJsonInput, LabelJsonInput=LabelJsonInput)
