...
class WebhookSubscriptionQuery(UniversalBaseModel):
...
update_forward_refs(WebhookSubscriptionQuery, FullJsonInput=FullJsonInput, LabelJsonInput=LabelJsonInput)
