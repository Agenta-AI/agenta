...
class EvaluationQueueQuery(UniversalBaseModel):
    flags: typing.Optional[EvaluationQueueQueryFlags] = None
...
update_forward_refs(EvaluationQueueQuery, FullJsonInput=FullJsonInput, LabelJsonInput=LabelJsonInput)
