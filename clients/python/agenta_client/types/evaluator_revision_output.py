...
class EvaluatorRevisionOutput(UniversalBaseModel):
    ...
    flags: typing.Optional[EvaluatorRevisionFlags] = None
    ...
    data: typing.Optional[EvaluatorRevisionDataOutput] = None
...
update_forward_refs(EvaluatorRevisionOutput, FullJsonOutput=FullJsonOutput, LabelJsonOutput=LabelJsonOutput)
