...
class EnvironmentVariantCreate(UniversalBaseModel):
...
update_forward_refs(EnvironmentVariantCreate, FullJsonInput=FullJsonInput, LabelJsonInput=LabelJsonInput)
