...
class WebhookSubscriptionCreate(UniversalBaseModel):
...
update_forward_refs(WebhookSubscriptionCreate, FullJsonInput=FullJsonInput, LabelJsonInput=LabelJsonInput)
