...
class ApplicationRevisionDataOutput(UniversalBaseModel):
    uri: typing.Optional[str] = None
    url: typing.Optional[str] = None
    headers: typing.Optional[typing.Dict[str, typing.Optional[ApplicationRevisionDataOutputHeadersValue]]] = None
    runtime: typing.Optional[ApplicationRevisionDataOutputRuntime] = None
...
update_forward_refs(ApplicationRevisionDataOutput, FullJsonOutput=FullJsonOutput)
