...
class SpanInput(UniversalBaseModel):
    ...
    start_time: typing.Optional[SpanInputStartTime] = None
    end_time: typing.Optional[SpanInputEndTime] = None
...
update_forward_refs(SpanInput, FullJsonInput=FullJsonInput)
