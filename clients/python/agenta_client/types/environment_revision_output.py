...
class EnvironmentRevisionOutput(UniversalBaseModel):
...
update_forward_refs(EnvironmentRevisionOutput, FullJsonOutput=FullJsonOutput, LabelJsonOutput=LabelJsonOutput)
