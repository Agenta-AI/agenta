...
class SimpleApplicationCreate(UniversalBaseModel):
    flags: typing.Optional[SimpleApplicationFlags] = None
    ...
    data: typing.Optional[SimpleApplicationDataInput] = None
...
update_forward_refs(SimpleApplicationCreate, FullJsonInput=FullJsonInput, LabelJsonInput=LabelJsonInput)
