...
class SimpleQueueCreate(UniversalBaseModel):
    ...
    data: typing.Optional[SimpleQueueData] = None
...
update_forward_refs(SimpleQueueCreate, FullJsonInput=FullJsonInput, LabelJsonInput=LabelJsonInput)
