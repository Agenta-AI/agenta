...
from .types.ee_src_models_api_organization_models_organization import (
...
if typing.TYPE_CHECKING:
    ...
    from .ai_services.client import AiServicesClient, AsyncAiServicesClient
    ...
    from .simple_traces.client import AsyncSimpleTracesClient, SimpleTracesClient
...
class AgentaApi:
    ...
    def __init__(
        ...
        *,
        ...
        self._simple_traces: typing.Optional[SimpleTracesClient] = None
        ...
        self._ai_services: typing.Optional[AiServicesClient] = None
    ...
    @property
    def simple_traces(self):
        if self._simple_traces is None:
            from .simple_traces.client import SimpleTracesClient  # noqa: E402

            self._simple_traces = SimpleTracesClient(
                client_wrapper=self._client_wrapper
            )
        return self._simple_traces
    ...
    def ai_services(self):
        if self._ai_services is None:
            from .ai_services.client import AiServicesClient  # noqa: E402

            self._ai_services = AiServicesClient(client_wrapper=self._client_wrapper)
...
class AsyncAgentaApi:
    ...
    def __init__(
        ...
        *,
        ...
        self._simple_traces: typing.Optional[AsyncSimpleTracesClient] = None
        ...
        self._ai_services: typing.Optional[AsyncAiServicesClient] = None
    ...
    def simple_traces(self):
        if self._simple_traces is None:
            from .simple_traces.client import AsyncSimpleTracesClient  # noqa: E402

            self._simple_traces = AsyncSimpleTracesClient(
                client_wrapper=self._client_wrapper
            )
        return self._simple_traces
    ...
    def ai_services(self):
        if self._ai_services is None:
            from .ai_services.client import AsyncAiServicesClient  # noqa: E402

            self._ai_services = AsyncAiServicesClient(
                client_wrapper=self._client_wrapper
            )
        return self._ai_services
