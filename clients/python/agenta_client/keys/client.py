...
class KeysClient:
    ...
    def list_api_keys(self, *, request_options: typing.Optional[RequestOptions] = None) -> typing.List[ListApiKeysResponse]:
        """
    ...
    def create_api_key(self, *, request_options: typing.Optional[RequestOptions] = None) -> str:
        ...
        client.keys.create_api_key()
        """
        _response = self._raw_client.create_api_key(request_options=request_options)
        return _response.data
    
    def delete_api_key(self, key_prefix: str, *, request_options: typing.Optional[RequestOptions] = None) -> typing.Dict[str, typing.Any]:
        """
...
class AsyncKeysClient:
    ...
    async def list_api_keys(self, *, request_options: typing.Optional[RequestOptions] = None) -> typing.List[ListApiKeysResponse]:
        """
        List all API keys associated with the authenticated user.
        ...
        async def main() -> None:
            await client.keys.list_api_keys()
    ...
    async def create_api_key(self, *, request_options: typing.Optional[RequestOptions] = None) -> str:
        ...
        async def main() -> None:
            await client.keys.create_api_key()
    ...
    async def delete_api_key(self, key_prefix: str, *, request_options: typing.Optional[RequestOptions] = None) -> typing.Dict[str, typing.Any]:
        """
        Delete an API key with the given key prefix for the authenticated user.
        ...
        async def main() -> None:
            await client.keys.delete_api_key(
                key_prefix="key_prefix",
            )
