...
class RawWorkflowsClient:
    ...
    def commit_agent_workflow_revision(self, *, workflow_revision: WorkflowRevisionCommit, workflow_variant_id: typing.Optional[str] = None, request_options: typing.Optional[RequestOptions] = None) -> HttpResponse[WorkflowRevisionResponse]:
        """
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            "workflows/revisions/commit/agent",method="POST",
            params={"workflow_variant_id": workflow_variant_id, }
            ,
            json={
                "workflow_revision": convert_and_respect_annotation_metadata(object_=workflow_revision, annotation=WorkflowRevisionCommit, direction="write"),
    ...
    def read_workflow_revision_config(self, *, target: ReadConfigTarget, max_bytes: typing.Optional[int] = OMIT, request_options: typing.Optional[RequestOptions] = None) -> HttpResponse[ReadConfigResponse]:
        """
        Parameters
        ----------
        ...
        Returns
        -------
        HttpResponse[ReadConfigResponse]
            Successful Response
        """
        _response = self._client_wrapper.httpx_client.request(
            "workflows/revisions/read-config",method="POST",
            json={
                "target": convert_and_respect_annotation_metadata(object_=target, annotation=ReadConfigTarget, direction="write"),
                "max_bytes": max_bytes,
            }
            ,
            headers={"content-type": "application/json", }
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ReadConfigResponse,
                    parse_obj_as(
                        type_ =ReadConfigResponse,  # type: ignore
                        object_ =_response.json()
                    )
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawWorkflowsClient:
    ...
    async def commit_agent_workflow_revision(self, *, workflow_revision: WorkflowRevisionCommit, workflow_variant_id: typing.Optional[str] = None, request_options: typing.Optional[RequestOptions] = None) -> AsyncHttpResponse[WorkflowRevisionResponse]:
        """
        The agent's own route: every write is confined to `parameters.agent`.
    ...
    async def read_workflow_revision_config(self, *, target: ReadConfigTarget, max_bytes: typing.Optional[int] = OMIT, request_options: typing.Optional[RequestOptions] = None) -> AsyncHttpResponse[ReadConfigResponse]:
        """
        Parameters
        ----------
        target : ReadConfigTarget
        ...
        Returns
        -------
        AsyncHttpResponse[ReadConfigResponse]
            Successful Response
        """
        _response = await self._client_wrapper.httpx_client.request(
            "workflows/revisions/read-config",method="POST",
