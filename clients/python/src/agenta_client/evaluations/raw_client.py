...
class RawEvaluationsClient:
    ...
    def fetch_run(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"evaluations/runs/{jsonable_encoder(run_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def close_run(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"evaluations/runs/{jsonable_encoder(run_id)}/close/{jsonable_encoder(status)}",
            method="POST",
            request_options=request_options,
        )
        try:
    ...
    def open_run(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"evaluations/runs/{jsonable_encoder(run_id)}/open",
            method="POST",
            request_options=request_options,
        )
        try:
    ...
    def fetch_scenario(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"evaluations/scenarios/{jsonable_encoder(scenario_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def fetch_result(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"evaluations/results/{jsonable_encoder(result_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def fetch_queue(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"evaluations/queues/{jsonable_encoder(queue_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def query_evaluation_queue_scenarios(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"evaluations/queues/{jsonable_encoder(queue_id)}/scenarios/query",
            method="POST",
            json={
                "queue": convert_and_respect_annotation_metadata(
                    object_=queue,
                    annotation=typing.Optional[EvaluationQueueScenariosQuery],
                    direction="write",
                ),
                "scenario": convert_and_respect_annotation_metadata(
                    object_=scenario,
    ...
    def fetch_evaluation(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"simple/evaluations/{jsonable_encoder(evaluation_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def start_simple_evaluation(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"simple/evaluations/{jsonable_encoder(evaluation_id)}/start",
            method="POST",
            request_options=request_options,
        )
        try:
    ...
    def stop_evaluation(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"simple/evaluations/{jsonable_encoder(evaluation_id)}/stop",
            method="POST",
            request_options=request_options,
        )
        try:
    ...
    def close_evaluation(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"simple/evaluations/{jsonable_encoder(evaluation_id)}/close",
            method="POST",
            request_options=request_options,
        )
        try:
    ...
    def open_evaluation(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"simple/evaluations/{jsonable_encoder(evaluation_id)}/open",
            method="POST",
            request_options=request_options,
        )
        try:
    ...
    def create_simple_queue(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json={
                "queue": convert_and_respect_annotation_metadata(
                    object_=queue, annotation=SimpleQueueCreate, direction="write"
                ),
            },
            headers={
                "content-type": "application/json",
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json={
                "queue": convert_and_respect_annotation_metadata(
                    object_=queue,
                    annotation=typing.Optional[SimpleQueueQuery],
                    direction="write",
                ),
                "windowing": convert_and_respect_annotation_metadata(
                    object_=windowing,
    ...
    def fetch_simple_queue(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"simple/queues/{jsonable_encoder(queue_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def query_simple_queue_scenarios(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"simple/queues/{jsonable_encoder(queue_id)}/scenarios/query",
            method="POST",
            json={
                "queue": convert_and_respect_annotation_metadata(
                    object_=queue,
                    annotation=typing.Optional[SimpleQueueScenariosQuery],
                    direction="write",
                ),
                "scenario": convert_and_respect_annotation_metadata(
                    object_=scenario,
    ...
    def add_simple_queue_traces(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"simple/queues/{jsonable_encoder(queue_id)}/traces/",
            method="POST",
            json={
                "trace_ids": trace_ids,
            },
    ...
    def add_simple_queue_testcases(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"simple/queues/{jsonable_encoder(queue_id)}/testcases/",
            method="POST",
            json={
