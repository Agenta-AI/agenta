...
from ..types.evaluator_catalog_templates_response import (
...
class EvaluatorsClient:
    ...
    def list_evaluator_catalog_types(
        ...
        """
        _response = self._raw_client.list_evaluator_catalog_types(
            request_options=request_options
        )
        return _response.data

    def list_evaluator_catalog_templates(
        self,
        *,
        ...
        """
        _response = self._raw_client.list_evaluator_catalog_templates(
            include_archived=include_archived, request_options=request_options
        )
        return _response.data

    def fetch_evaluator_catalog_template(
        self,
        template_key: str,
        *,
        request_options: typing.Optional[RequestOptions] = None,
        ...
        """
        _response = self._raw_client.fetch_evaluator_catalog_template(
            template_key, request_options=request_options
        )
        return _response.data

    def list_evaluator_catalog_presets(
        self,
        template_key: str,
        *,
        include_archived: typing.Optional[bool] = None,
        ...
        """
        _response = self._raw_client.list_evaluator_catalog_presets(
            template_key,
    ...
    def fetch_evaluator_catalog_preset(
        self,
        template_key: str,
        preset_key: str,
        *,
        ...
        """
        _response = self._raw_client.fetch_evaluator_catalog_preset(
    ...
    def deploy_evaluator_revision(
        ...
        *,
        ...
        """
        _response = self._raw_client.deploy_evaluator_revision(
            evaluator_ref=evaluator_ref,
            evaluator_variant_ref=evaluator_variant_ref,
            evaluator_revision_ref=evaluator_revision_ref,
            environment_ref=environment_ref,
    ...
    def resolve_evaluator_revision(
        self,
        *,
        evaluator_ref: typing.Optional[Reference] = OMIT,
        evaluator_variant_ref: typing.Optional[Reference] = OMIT,
        ...
        """
        _response = self._raw_client.resolve_evaluator_revision(
            evaluator_ref=evaluator_ref,
            evaluator_variant_ref=evaluator_variant_ref,
            evaluator_revision_ref=evaluator_revision_ref,
            max_depth=max_depth,
    ...
    def list_evaluator_templates(
        ...
        *,
        ...
        """
        _response = self._raw_client.list_evaluator_templates(
            include_archived=include_archived, request_options=request_options
        )
        return _response.data
...
class AsyncEvaluatorsClient:
    ...
    async def list_evaluator_catalog_types(
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.list_evaluator_catalog_types(
            request_options=request_options
        )
        return _response.data
    ...
    async def list_evaluator_catalog_templates(
        ...
        *,
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.list_evaluator_catalog_templates(
            include_archived=include_archived, request_options=request_options
        )
        return _response.data
    ...
    async def fetch_evaluator_catalog_template(
        ...
        *,
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.fetch_evaluator_catalog_template(
            template_key, request_options=request_options
        )
        return _response.data
    ...
    async def list_evaluator_catalog_presets(
        ...
        *,
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.list_evaluator_catalog_presets(
            template_key,
            include_archived=include_archived,
            request_options=request_options,
        )
    ...
    async def fetch_evaluator_catalog_preset(
        ...
        *,
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.fetch_evaluator_catalog_preset(
            template_key, preset_key, request_options=request_options
        )
        return _response.data
    ...
    async def deploy_evaluator_revision(
        ...
        *,
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.deploy_evaluator_revision(
            evaluator_ref=evaluator_ref,
            evaluator_variant_ref=evaluator_variant_ref,
            evaluator_revision_ref=evaluator_revision_ref,
            environment_ref=environment_ref,
    ...
    async def resolve_evaluator_revision(
        ...
        *,
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.resolve_evaluator_revision(
            evaluator_ref=evaluator_ref,
            evaluator_variant_ref=evaluator_variant_ref,
            evaluator_revision_ref=evaluator_revision_ref,
            max_depth=max_depth,
    ...
    async def list_evaluator_templates(
        ...
        *,
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.list_evaluator_templates(
            include_archived=include_archived, request_options=request_options
        )
        return _response.data
