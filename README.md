...
```bash
docker compose -f hosting/docker-compose/oss/docker-compose.dev.yml --env-file hosting/docker-compose/oss/.env.oss.dev --profile with-web --profile with-traefik up -d
```
