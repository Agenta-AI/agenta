...
<img className="dark:hidden" src="/images/basic_guides/17_begin_evaluation_modal_light.png" />
<img className="hidden dark:block" src="/images/basic_guides/17_begin_evaluation_modal_dark.png" />
...
<img className="dark:hidden" src="/images/basic_guides/18_begin_evaluation_modal_advanced_config_light.png" />
<img className="hidden dark:block" src="/images/basic_guides/18_begin_evaluation_modal_advanced_config_dark.png" />
...
<img className="dark:hidden" src="/images/basic_guides/19_view_evaluation_result_light.png" />
<img className="hidden dark:block" src="/images/basic_guides/19_view_evaluation_result_dark.png" />
...
<img className="dark:hidden" src="/images/basic_guides/20_evaluation_comparison_view_light.png" />
<img className="hidden dark:block" src="/images/basic_guides/20_evaluation_comparison_view_dark.png" />
