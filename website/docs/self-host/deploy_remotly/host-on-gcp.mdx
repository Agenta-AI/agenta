...
:::tip
This guide is for provisioning and deploying agenta on GCP Compute Engine **using Terraform**. If you prefer to provision the instance manually, you can use the [guide for deploying on a remote machine](/self-host/host-remotely/).
:::
