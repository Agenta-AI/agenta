...
:::tip
This guide is for provisioning and deploying agenta on AWS EC2 **using Terraform**. If you prefer to provision the instance manually, you can use the [guide for deploying on a remote machine](/self-host/host-remotely/).
:::
