...
<img className="dark:hidden" src="/images/misc/team_management_light.png" />
<img className="hidden dark:block" src="/images/misc/team_management_dark.png" />
...
<img className="dark:hidden" src="/images/misc/workspace_tab_light.png" />
<img className="hidden dark:block" src="/images/misc/workspace_tab_dark.png" />