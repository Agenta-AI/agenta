...
### v0.14.14 - New LLM Provider: Welcome Gemini!
*25 May 2024*
...
### v0.14.1-13 - Playground Improvements
*24 May 2024*
...
<img className="dark:hidden" src="/images/changelog/default-selected-testset_video.gif" />
...
### v0.14.0 - Prompt and Configuration Registry
*1 May 2024*
...
<img className="dark:hidden" src="/images/changelog/publish_to_production_by_default_screenshot.png" />

----

### v0.13.8 - Improvements
*28 April 2024*
...
<img className="dark:hidden" src="/images/changelog/total_cost_screenshot.png" />
...
<img className="dark:hidden" src="/images/changelog/observability_beta_light.png" />
<img className="hidden dark:block" src="/images/changelog/observability_beta_dark.png" />
...
<img className="dark:hidden" src="/images/changelog/compare_latency_and_cost_light.png" />
<img className="hidden dark:block" src="/images/changelog/compare_latency_and_cost_dark.png" />
...
<img className="dark:hidden" src="/images/changelog/toggle_variants_visibility_light.png" />
<img className="hidden dark:block" src="/images/changelog/toggle_variants_visibility_dark.png" />
...
<img className="dark:hidden" src="/images/changelog/prompt_versioning_light.png" />
<img className="hidden dark:block" src="/images/changelog/prompt_versioning_dark.png" />
...
<img className="dark:hidden" src="/images/changelog/new_json_evaluator_light.png" />
<img className="hidden dark:block" src="/images/changelog/new_json_evaluator_dark.png" />
...
<img className="dark:hidden" src="/images/changelog/improved_error_handling_light.png" />
<img className="hidden dark:block" src="/images/changelog/improved_error_handling_dark.png" />
...
<img className="dark:hidden" src="/images/changelog/improved_human_eval_workflow_light.png" />
<img className="hidden dark:block" src="/images/changelog/improved_human_eval_workflow_dark.png" />
