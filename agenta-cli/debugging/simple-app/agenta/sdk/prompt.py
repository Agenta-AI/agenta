...
class Prompt(BaseModel):
    ...
    stop_sequences: Optional[List[str]] = Field(default=None, description="List of sequences where the model should stop generating")
    model_parameters: Optional[Dict[str, Any]] = Field(default=None, description="Additional model-specific parameters")
