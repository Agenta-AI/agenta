...
class TestsetsClient:
    ...
    def get_testset_testsets_testset_id_get(self, testset_id: str) -> typing.Any:
        """
    ...
    def get_testsets_testsets_get(
        ...
        client.get_testsets_testsets_get(app_id="app-id")
        """
        _response = self._client_wrapper.httpx_client.request(
            "GET",
...
class AsyncTestsetsClient:
    ...
    async def get_testset_testsets_testset_id_get(self, testset_id: str) -> typing.Any:
        """
        Fetch a specific testset in a MongoDB collection using its _id.
    ...
    async def get_testsets_testsets_get(
        ...
        await client.get_testsets_testsets_get(app_id="app-id")
        """
        _response = await self._client_wrapper.httpx_client.request(
            "GET",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "testsets"),
