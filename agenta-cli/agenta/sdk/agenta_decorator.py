...
def override_schema(
    openapi_schema: dict, func_name: str, endpoint: str, config_params: dict
):
    """
    ...
    Args:
        ...
        config_params (dict(param_name, param_val)): The dictionary of optional parameters for the function
    """
