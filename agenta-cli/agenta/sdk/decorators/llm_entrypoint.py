...
class entrypoint(BaseDecorator):
    ...
    def __call__(self, func: Callable[..., Any]) -> Callable[..., Any]:
        ...
        async def wrapper_deployed(*args, **kwargs) -> Any:
            func_params = {k: v for k, v in kwargs.items() if k not in ["config", "environment"]}
        ...
        self.update_function_signature(wrapper, func_signature, config_params, ingestible_files)
    ...
    def ingest_files(
        self, func_params: Dict[str, Any], ingestible_files: Dict[str, inspect.Parameter]
    ) -> None:
    ...
    def update_wrapper_signature(self, wrapper: Callable[..., Any], updated_params: List):
        """
    ...
    def override_schema(self, openapi_schema: dict, func_name: str, endpoint: str, params: dict):
        """
