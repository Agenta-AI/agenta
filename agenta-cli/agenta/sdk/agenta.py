...
def post(func: Callable[..., Any]):
    ...
    app.post(route)(wrapper)
    override_schema(openapi_schema=app.openapi(),
...
def override_schema(openapi_schema: dict, func_name: str, endpoint: str, app_params: dict):
    """
    ...
    def find_in_schema(schema: dict, param_name: str, xparam: str):
        ...
        for _, value in schema.items():
            ...
            if (
                ...
                return value
    schema_to_override = openapi_schema["components"]["schemas"][f"Body_{func_name}_{endpoint}_post"][
        "properties"
    ]
