...
export type RenderHint =
  ...
  // stamps it so the frontend renders the OAuth/API-key connect dialog when the tool parks. No
  // payload — the widget is fully described by the parked call's tool name + input. `wire.py` does
