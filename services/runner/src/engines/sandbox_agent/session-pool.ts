/**
 * Mutable lifecycle storage for parked sandbox-agent sessions.
 *
 * Identity, fingerprint, credential, provider, and key policy lives in
 * `session-identity.ts`; this module owns only the map, timers, capacity, state
 * transitions, and idempotent teardown.
 */
