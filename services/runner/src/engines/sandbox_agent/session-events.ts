import type { SessionEvent, SessionPermissionRequest } from "sandbox-agent";
 ...
 */
export function routeSessionEventToActiveTurn(
 ...
 * it cannot hang.
 */
export function routePermissionRequestToActiveTurn(
  environment: SessionEnvironment,
