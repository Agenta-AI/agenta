...
class EnvironmentRevisionInput(UniversalBaseModel):
...
update_forward_refs(EnvironmentRevisionInput, FullJsonInput=FullJsonInput, LabelJsonInput=LabelJsonInput)
