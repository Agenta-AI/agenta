...
class EnvironmentRevisionCreate(UniversalBaseModel):
...
update_forward_refs(EnvironmentRevisionCreate, FullJsonInput=FullJsonInput, LabelJsonInput=LabelJsonInput)
