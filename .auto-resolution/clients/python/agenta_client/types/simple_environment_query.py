...
class SimpleEnvironmentQuery(UniversalBaseModel):
    flags: typing.Optional[EnvironmentQueryFlags] = None
...
update_forward_refs(SimpleEnvironmentQuery, FullJsonInput=FullJsonInput, LabelJsonInput=LabelJsonInput)
