...
class InvocationEdit(UniversalBaseModel):
    ...
    links: typing.Optional[InvocationEditLinks] = None
...
update_forward_refs(InvocationEdit, FullJsonInput=FullJsonInput, LabelJsonInput=LabelJsonInput)
