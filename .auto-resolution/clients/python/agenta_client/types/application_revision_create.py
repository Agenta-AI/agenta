...
class ApplicationRevisionCreate(UniversalBaseModel):
    ...
    flags: typing.Optional[ApplicationFlags] = None
...
update_forward_refs(ApplicationRevisionCreate, FullJsonInput=FullJsonInput, LabelJsonInput=LabelJsonInput)
