...
For more information on evaluations, see our [Evaluation documentation](/1.0/evaluation/concepts).
...
1. **[Human evaluation](/1.0/evaluation/human-evaluation/quick-start)**: Have people review the outputs for quality
2. **[LLM as a judge](/1.0/evaluation/configure-evaluators/llm-as-a-judge)**: Use a prompt that assesses outputs based on criteria like relevance or accuracy
...
- [Creating Test Sets](/1.0/evaluation/managing-test-sets/upload-csv)
- [Configuring Evaluators](/1.0/evaluation/configure-evaluators/overview)
- [Running Evaluations](/1.0/evaluation/evaluation-from-ui/running-evaluations)
