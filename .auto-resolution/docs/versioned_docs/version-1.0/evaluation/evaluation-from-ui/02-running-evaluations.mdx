...
Before you get started, make sure that you have [created a test set](/1.0/evaluation/managing-test-sets/upload-csv) and [configured evaluators](/1.0/evaluation/configure-evaluators/overview) appropriate for your task.
...
- Learn how to [view evaluation results](/1.0/evaluation/evaluation-from-ui/viewing-results)
- Understand how to [compare evaluations](/1.0/evaluation/evaluation-from-ui/comparing-runs)
- Try [human evaluation](/1.0/evaluation/human-evaluation/quick-start) for expert feedback
