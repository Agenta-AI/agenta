...
For more advanced observability features and configuration options, see our [complete observability documentation](/1.0/observability/trace-with-python-sdk/setup-tracing).
