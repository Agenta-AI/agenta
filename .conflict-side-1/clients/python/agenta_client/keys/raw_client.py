...
class RawKeysClient:
    ...
    def list_api_keys(self, *, request_options: typing.Optional[RequestOptions] = None) -> HttpResponse[typing.List[ListApiKeysResponse]]:
        """
    ...
    def create_api_key(self, *, request_options: typing.Optional[RequestOptions] = None) -> HttpResponse[str]:
        """
    ...
    def delete_api_key(self, key_prefix: str, *, request_options: typing.Optional[RequestOptions] = None) -> HttpResponse[typing.Dict[str, typing.Any]]:
        """
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"keys/{jsonable_encoder(key_prefix)}",method="DELETE",
            request_options=request_options,)
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
...
class AsyncRawKeysClient:
    ...
    async def list_api_keys(self, *, request_options: typing.Optional[RequestOptions] = None) -> AsyncHttpResponse[typing.List[ListApiKeysResponse]]:
        """
        List all API keys associated with the authenticated user.
    ...
    async def create_api_key(self, *, request_options: typing.Optional[RequestOptions] = None) -> AsyncHttpResponse[str]:
        """
        Creates an API key for a user.
    ...
    async def delete_api_key(self, key_prefix: str, *, request_options: typing.Optional[RequestOptions] = None) -> AsyncHttpResponse[typing.Dict[str, typing.Any]]:
        """
        Delete an API key with the given key prefix for the authenticated user.
