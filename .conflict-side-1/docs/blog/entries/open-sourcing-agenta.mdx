...
Development moves back to the public repository. We're building in public again. Only enterprise collaboration features like SSO and audit logs remain under a separate license.
...
Only enterprise collaboration features stay under a separate license. This includes single sign-on (SSO) and audit logs. These features support teams with specific compliance and security requirements.
