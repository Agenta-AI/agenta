...
To learn how to test multimodal content interactively before integrating, see [Images and PDFs in the Playground](/1.0/prompt-engineering/playground/multimodal-content).
