...
- Learn how to [configure custom evaluators](/1.0/evaluation/evaluation-from-sdk/configuring-evaluators) with different scoring logic
- Explore [built-in evaluators](/1.0/evaluation/evaluation-from-sdk/configuring-evaluators#built-in-evaluators) like LLM-as-a-judge
- Understand how to [configure your application](/1.0/evaluation/evaluation-from-sdk/configuring-applications) for different use cases
- Run [multiple evaluators](/1.0/evaluation/evaluation-from-sdk/running-evaluations) in a single evaluation
