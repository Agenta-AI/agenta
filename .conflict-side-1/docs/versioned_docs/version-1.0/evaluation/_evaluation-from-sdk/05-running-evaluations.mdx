...
- Learn about [viewing results](/1.0/evaluation/evaluation-from-sdk/viewing-results)
- Explore [advanced evaluation patterns](/1.0/evaluation/evaluation-from-sdk/setup-configuration)
