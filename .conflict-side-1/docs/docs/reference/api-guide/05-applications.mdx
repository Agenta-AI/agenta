...
[Custom workflows](/1.0/custom-workflows/overview) are also applications. They let you point Agenta at your own HTTP handler or code, so the prompt, model parameters, and runtime behaviour live in your service while versioning, deployment, and invocation stay in Agenta.
