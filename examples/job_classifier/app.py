...
default_sm = "You are a world class algorithm for extracting information in structured formats."
...
def generate(
    ...
    chain = create_structured_output_chain(create_job_class(company_desc=company_desc_message,
