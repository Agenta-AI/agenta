rag_evaluator_settings_template = {
    ...
    "answer_key": {
        ...
        "required": True,
        "advanced": False,
        "description": "The response generated by the language model based on the given question and the retrieved documents. This output is evaluated for its accuracy and faithfulness to the context provided by the retrieved documents.",
    },
    "contexts_key": {
        "label": "Expected Contexts Key",
        "default": "",
        "type": "string",
        "required": True,
        "advanced": False,
        "description": "The documents or snippets of information retrieved by the language model during the process of generating an answer. These contexts provide the basis for the model's response and are used to assess the faithfulness of the generated answer.",
    },
}
evaluators = [
    {
