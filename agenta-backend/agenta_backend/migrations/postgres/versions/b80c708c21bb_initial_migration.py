...
def returning_user_from_agenta_v018_downwards_upgrade() -> None:
    ...
    op.create_unique_constraint(
        "evaluation_aggregated_results_pkey", "evaluation_aggregated_results", ["id"]
    )
    op.create_unique_constraint(
    ...
    op.create_unique_constraint("evaluators_configs_pkey", "evaluators_configs", ["id"])
    op.create_unique_constraint(
        "human_evaluation_variants_pkey", "human_evaluation_variants", ["id"]
    )
    op.create_unique_constraint("human_evaluations_pkey", "human_evaluations", ["id"])
    op.create_unique_constraint(
