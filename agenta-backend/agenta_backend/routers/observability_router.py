...
@router.get("/traces/{app_id}/{variant_id}/", response_model=List[Trace], operation_id="get_traces")
...
@router.get("/traces/{trace_id}/", response_model=Trace, operation_id="get_single_trace")
...
@router.get("/spans/{trace_id}/", response_model=List[Span], operation_id="get_spans_of_trace")
...
@router.put("/traces/{trace_id}/", response_model=bool, operation_id="update_trace_status")
...
@router.post("/feedbacks/{trace_id}/", response_model=str, operation_id="create_feedback")
...
@router.get("/feedbacks/{trace_id}/", response_model=List[Feedback], operation_id="get_feedbacks")
...
@router.get("/feedbacks/{trace_id}/{feedback_id}/", response_model=Feedback, operation_id="get_feedback")
...
@router.put("/feedbacks/{trace_id}/{feedback_id}/", response_model=Feedback, operation_id="update_feedback")
