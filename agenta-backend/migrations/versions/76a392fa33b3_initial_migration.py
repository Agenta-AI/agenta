...
Revision ID: 76a392fa33b3
Revises: 
Create Date: 2024-07-08 09:40:43.371352
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['image_id'], ['docker_images.id'], ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['evaluation_id'], ['human_evaluations.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['base_id'], ['bases.id'], ),
    sa.ForeignKeyConstraint(['modified_by_id'], ['users.id'], ),
    sa.ForeignKeyConstraint(['variant_id'], ['app_variants.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('id')
    )
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=True),
    sa.ForeignKeyConstraint(['app_id'], ['app_db.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['deployed_app_variant_id'], ['app_variants.id'], ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['deployed_app_variant_revision_id'], ['app_variant_revisions.id'], ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['deployment_id'], ['deployments.id'], ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('id')
    ...
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.ForeignKeyConstraint(['variant_id'], ['app_variants.id'], ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['variant_revision_id'], ['app_variant_revisions.id'], ondelete='SET NULL'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('id')
    )
    op.create_table('human_evaluation_variants',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('human_evaluation_id', sa.UUID(), nullable=True),
    sa.Column('variant_id', sa.UUID(), nullable=True),
    sa.Column('variant_revision_id', sa.UUID(), nullable=True),
    sa.ForeignKeyConstraint(['human_evaluation_id'], ['human_evaluations.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['variant_id'], ['app_variants.id'], ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['variant_revision_id'], ['app_variant_revisions.id'], ondelete='SET NULL'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('id')
    ...
    op.create_table('evaluation_aggregated_results',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('evaluation_id', sa.UUID(), nullable=True),
    sa.Column('evaluator_config_id', sa.UUID(), nullable=True),
    sa.Column('result', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    sa.ForeignKeyConstraint(['evaluation_id'], ['evaluations.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['evaluator_config_id'], ['evaluators_configs.id'], ondelete='SET NULL'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('id')
    )
    op.create_table('evaluation_evaluator_configs',
    sa.Column('id', sa.UUID(), nullable=False),
    ...
    op.create_table('evaluation_scenario_results',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('evaluation_scenario_id', sa.UUID(), nullable=True),
    sa.Column('evaluator_config_id', sa.UUID(), nullable=True),
    sa.Column('result', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    sa.ForeignKeyConstraint(['evaluation_scenario_id'], ['evaluation_scenarios.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['evaluator_config_id'], ['evaluators_configs.id'], ondelete='SET NULL'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('id')
    )
