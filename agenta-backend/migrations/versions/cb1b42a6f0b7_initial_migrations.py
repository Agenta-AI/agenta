...
Revision ID: cb1b42a6f0b7
Revises:
Create Date: 2024-06-07 11:27:36.536156
...
from agenta_backend.models.fields import pydantic_jsonb

# revision identifiers, used by Alembic.
revision: str = "cb1b42a6f0b7"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "aggregated_results",
            pydantic_jsonb.PydanticJSONB(astext_type=sa.Text()),
            nullable=True,
        ),
        sa.Column(
            "average_cost",
    ...
    op.create_table(
        ...
        sa.Column("variant_id", sa.UUID(), nullable=True),
        sa.Column(
            "inputs", pydantic_jsonb.PydanticJSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
            "outputs",
            pydantic_jsonb.PydanticJSONB(astext_type=sa.Text()),
