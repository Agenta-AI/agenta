...
class Meters(str, Enum):
    ...
    SANDBOX_VCPU_CORE_SECONDS = Counter.SANDBOX_VCPU_CORE_SECONDS.value
    SANDBOX_VMEM_GIBI_SECONDS = Counter.SANDBOX_VMEM_GIBI_SECONDS.value
    SANDBOX_DISK_GIBI_SECONDS = Counter.SANDBOX_DISK_GIBI_SECONDS.value
    SANDBOX_VGPU_CORE_SECONDS = Counter.SANDBOX_VGPU_CORE_SECONDS.value
    # GAUGES
