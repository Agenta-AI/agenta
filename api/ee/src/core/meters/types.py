...
class Meters(str, Enum):
    ...
    SANDBOX_CPU_CORE_CREDITS = Counter.SANDBOX_CPU_CORE_CREDITS.value
    SANDBOX_RAM_GIBI_CREDITS = Counter.SANDBOX_RAM_GIBI_CREDITS.value
    SANDBOX_SSD_GIBI_CREDITS = Counter.SANDBOX_SSD_GIBI_CREDITS.value
    SANDBOX_GPU_CORE_CREDITS = Counter.SANDBOX_GPU_CORE_CREDITS.value
