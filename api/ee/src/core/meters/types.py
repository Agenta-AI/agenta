...
class Meters(str, Enum):
    ...
    SANDBOX_CPU_SECONDS = Counter.SANDBOX_CPU_SECONDS.value
    SANDBOX_RAM_SECONDS = Counter.SANDBOX_RAM_SECONDS.value
    SANDBOX_SSD_SECONDS = Counter.SANDBOX_SSD_SECONDS.value
    SANDBOX_GPU_SECONDS = Counter.SANDBOX_GPU_SECONDS.value
    # GAUGES
