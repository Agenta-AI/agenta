...
OPENLLMETRY_ATTRIBUTES_EXACT: List[Tuple[str, str]] = [
    ...
    ("llm.usage.prompt_tokens", "ag.metrics.unit.tokens.prompt"),
    ("llm.usage.completion_tokens", "ag.metrics.unit.tokens.completion"),
    ("gen_ai.usage.prompt_tokens", "ag.metrics.unit.tokens.prompt"),
    ("gen_ai.usage.completion_tokens", "ag.metrics.unit.tokens.completion"),
    ("gen_ai.usage.cache_read_input_tokens", "ag.metrics.unit.tokens.cache_read"),
    (
