...
def mock_data(authed_api):
    ...
    response = authed_api(
        "POST",
        f"/v2/workflows/{workflow_id_1}/archive",
    )
    ...
    response = authed_api(
        "GET",
        "/v2/workflows/?include_archived=true",
    )
...
class TestWorkflowsQueries:
    ...
    def test_query_paginated_workflows(
        ...
        response = authed_api(
            "GET",
            "/v2/workflows/?include_archived=true&limit=1",
        )
        # ----------------------------------------------------------------------
