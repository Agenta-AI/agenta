...
return await __ag_workflow_runner__()
...
async def run_script_locally(
    *,
    ...
    """
    This function is used to run the TEST_SCRIPT locally.
    It is not part of the main workflow service but can be used for testing purposes.
    """
...
if __name__ == "__main__":
    ...
    if not serve:
        ...
        # quit with ctrl+c
        uvicorn.run(
            "oss.tests.manual.workflows.interface:app",
            host="0.0.0.0",
            port=8888,
            log_level="info",
            reload=True,
