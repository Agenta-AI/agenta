...
- New [cookbook for observability with LangChain](/1.0/tutorials/cookbooks/observability_langchain)
- Updated the [custom workflows documentation](/1.0/custom-workflows/overview) and added [reference](/1.0/reference/sdk/custom-workflow)
- Updated the [reference for the observability SDK](/1.0/reference/sdk/observability) and [for the prompt management SDK](/1.0/reference/sdk/configuration-management)
