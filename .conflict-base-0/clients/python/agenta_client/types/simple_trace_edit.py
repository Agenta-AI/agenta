...
class SimpleTraceEdit(UniversalBaseModel):
    ...
    links: typing.Optional[SimpleTraceEditLinks] = None
...
update_forward_refs(SimpleTraceEdit, FullJsonInput=FullJsonInput, LabelJsonInput=LabelJsonInput)
