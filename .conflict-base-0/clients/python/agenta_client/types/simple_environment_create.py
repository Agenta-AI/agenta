...
class SimpleEnvironmentCreate(UniversalBaseModel):
    flags: typing.Optional[EnvironmentFlags] = None
...
update_forward_refs(SimpleEnvironmentCreate, FullJsonInput=FullJsonInput, LabelJsonInput=LabelJsonInput)
