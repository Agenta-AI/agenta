...
class SimpleWorkflowDataOutput(UniversalBaseModel):
    uri: typing.Optional[str] = None
    url: typing.Optional[str] = None
    headers: typing.Optional[typing.Dict[str, typing.Optional[SimpleWorkflowDataOutputHeadersValue]]] = None
    runtime: typing.Optional[SimpleWorkflowDataOutputRuntime] = None
...
update_forward_refs(SimpleWorkflowDataOutput, FullJsonOutput=FullJsonOutput)
