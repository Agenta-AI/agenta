...
def _validate_webhook_url(url: str) -> str:
    ...
    reach an internal host. The guard logic lives once in `agenta.sdk.utils.net`;
    this wrapper applies this handler's own insecure-flag precedent (see
    `_HOOK_ALLOW_INSECURE` above).
    """
