...
def test_workflow_request_flags_type_exists():
    ...
    flags = WorkflowInvokeRequestFlags(stream=True, history=False, control=True)
...
# --------------------------------------------------------------------------- #
# The request boundary stays dict-ish (loose). WorkflowInvokeRequestFlags is the typed
